...
* You may now select multiple event types (e.g. publish / unpublish) or content types for a webhook. No more needing to create dozens of hooks to achieve what can now be done with just one!
