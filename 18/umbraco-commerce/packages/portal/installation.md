---
description: >-
  Detailed instructions on how to install and configure Portal into your Umbraco
...
![Installing Umbraco Commerce Portal via the NuGet Package Manager.](../../.gitbook/assets/ucp_nuget_package_manager.png)
...
![The Portal Dashboard in the Settings section of the Umbraco backoffice.](../../.gitbook/assets/ucp_installer_dashboard.png)

4. Click the **Install** button.
5. Select your site's root node which is configured with a Umbraco Commerce store.
6. Click **Install**.

![The dialog that appears when installing content through the Portal dashboard.](../../.gitbook/assets/ucp_install_modal_1.png) ![The selected root node configured with a Umbraco Commerce store.](../../.gitbook/assets/ucp_install_modal_2.png)
