...
* **Locations** - Defines different locations for a store. See [Locations reference documentation](https://github.com/umbraco/UmbracoDocs/blob/main/18/umbraco-commerce/reference/locations/README.md) for more details.
