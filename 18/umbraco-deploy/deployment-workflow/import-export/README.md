...
Once an item has been successfully queued, a confirmation message is shown. For example: _\[Item name] and its descendants have been successfully added to the export queue._
