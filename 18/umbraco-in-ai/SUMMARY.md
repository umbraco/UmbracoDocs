...
* [Base MCP](mcp/base-mcp/README.md)
  ...
  * [Hosted MCP Server](mcp/base-mcp/hosted-mcp/README.md)
    ...
    * [Deployment](mcp/base-mcp/hosted-mcp/deployment/README.md)
      * [Umbraco Setup](mcp/base-mcp/hosted-mcp/deployment/umbraco-setup.md)
      * [Local Development Setup](mcp/base-mcp/hosted-mcp/deployment/local-dev-setup.md)
...
* [Hosted MCP Setup](mcp/hosted-mcp-setup/README.md)
  * [Umbraco Cloud Quick Start](mcp/hosted-mcp-setup/cloud-quickstart.md)
  * [Self-Hosted Quick Start](mcp/hosted-mcp-setup/self-hosted-quickstart.md)
  * [Hosted Connections](mcp/hosted-mcp-setup/web-hosted-platforms.md)
    * [Claude.ai](mcp/hosted-mcp-setup/claude-ai.md)
    * [ChatGPT](mcp/hosted-mcp-setup/chatgpt.md)
  * [Local Connections](mcp/hosted-mcp-setup/local-apps.md)
    ...
    * [GitHub Copilot](mcp/hosted-mcp-setup/github-copilot.md)
