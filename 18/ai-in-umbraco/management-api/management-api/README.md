---
description: REST API for managing AI connections, profiles, and performing AI operations.
---
...
{% content-ref url="../context-resource-types/" %}
[context-resource-types](../context-resource-types/)
{% endcontent-ref %}

{% content-ref url="../embeddings/" %}
