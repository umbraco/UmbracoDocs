---
description: >-
  Breaking changes introduced in each major version of Umbraco CMS, with notes
  on what to update when upgrading.
---
...
For details, see the [Single block migration](find-your-upgrade-path/single-block-migration.md) article.
...
* **Delivery API member authentication** — `ConfigureUmbracoMemberAuthenticationDeliveryApiSwaggerGenOptions` has been removed. Use the `AddDeliveryApiOpenApiMemberAuthentication()` extension. See [Testing with Swagger](../../develop-with-umbraco/headless-and-apis/content-delivery-api/protected-content-in-the-delivery-api/#testing-with-swagger).
...
This change will likely impact custom Property Editors. See the [Migrate custom Property Editors to Umbraco version 14 and later](find-your-upgrade-path/migrate-custom-property-editors-to-umbraco-14.md) article for details.
