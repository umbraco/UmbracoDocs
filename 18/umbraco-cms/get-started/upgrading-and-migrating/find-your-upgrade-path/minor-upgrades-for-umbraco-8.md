...
* [Upgrade using NuGet](minor-upgrades-for-umbraco-8.md#upgrade-using-nuget)
* [Upgrade manually from a Zip file](minor-upgrades-for-umbraco-8.md#upgrade-manually-from-a-zip-file)
* [Run an unattended upgrade (v8.12+)](minor-upgrades-for-umbraco-8.md#run-an-unattended-upgrade)
