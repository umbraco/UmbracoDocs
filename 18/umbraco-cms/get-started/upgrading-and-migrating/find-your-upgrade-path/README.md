---
description: >-
  Version-specific upgrade notes and breaking changes for Umbraco, covering
  migration paths between different versions.
---
...
For more information on what has changed in Umbraco 14 read the [Breaking changes in Umbraco 14](../version-specific.md#umbraco-14).
