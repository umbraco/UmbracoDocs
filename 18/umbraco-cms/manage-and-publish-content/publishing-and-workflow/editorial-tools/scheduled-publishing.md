...
<figure><img src="../../../.gitbook/assets/image (20).png" alt="Scheduled publishing time"><figcaption><p>Scheduled publishing</p></figcaption></figure>
...
In some cases it might be easiest to specify the [umbracoSettings:settings/web.routing/@umbracoApplicationUrl](../../../develop-with-umbraco/configuration/webroutingsettings.md) setting. This is to ensure that your server is communicating to itself on the correct URL.
