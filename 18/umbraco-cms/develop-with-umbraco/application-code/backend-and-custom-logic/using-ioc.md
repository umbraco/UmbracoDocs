...
When working with packages, you do not have access to the `Program.cs` file. Instead, you can use a [composer](../../../model-your-content/content-types-and-structure/composing.md) to register your dependencies.
...
[Read more about the UmbracoHelper](../../templating-and-rendering/querying/umbracohelper.md)
...
{% hint style="info" %}
Using the UmbracoHelper is only possible when there is an instance of the UmbracoContext. [You can read more in the implementation article about services](../../../extend-your-project/server-side-extensions/services/).
{% endhint %}

### ExamineManager

[Read more about the ExamineManager in the Searching articles](../examine/).
...
[Read more about logging in the debugging section](../../testing-and-debugging/logging.md)
...
In the [Services and Helpers documentation](../../../extend-your-project/server-side-extensions/services/), you can find more examples of using dependency injection and gaining access to the different services and helpers.
