...
Read the [Creating a Backoffice API article](../../../../../extend-your-project/tutorials/creating-a-backoffice-api/) for a comprehensive guide to writing APIs for the Management API.
