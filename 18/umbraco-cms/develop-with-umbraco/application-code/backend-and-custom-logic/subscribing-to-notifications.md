---
description: >-
  Subscribing to notifications allows you to listen to specific events and run
  custom code in response.
---
...
1. Add a new C# class file to your project. For example: **\~/App\_Plugins/Notifications/LogWhenPublishedHandler.cs**.
...
Learn more about registering dependencies in the [Dependency Injection](using-ioc.md) article.
{% endhint %}
...
![Messages in Log](../../../.gitbook/assets/log-messages-v14.png)
...
* For further details on Notifications in Umbraco, see the [Using Notifications](../../../extend-your-project/server-side-extensions/notifications/) article.
