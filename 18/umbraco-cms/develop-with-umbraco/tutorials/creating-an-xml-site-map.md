...
We will start by adding the XML schema for the sitemap. Since we do not want our template to inherit a Layout Template, we will set the `layout` to be `null`.
