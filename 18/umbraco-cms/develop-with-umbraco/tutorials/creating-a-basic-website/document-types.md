...
5. Enter a **Name** for the **Document Type**. Let's call it _HomePage_. You'll notice that an **Alias** is automatically created.
   * The alias of the Document Type is automatically generated based on the property name. If you want to change the auto-generated alias, click the "lock" symbol. The alias must be in camelcase. For example _homePage_.
6. Click **Save**. The Document Type is now visible as a new item under **Document Types**.

![Saving a Document Type](../../../.gitbook/assets/saving-a-document-type.png)
...
2. Click **Add Group**.
3. Enter a Name for the group. For this tutorial, let's call it _Content_.
