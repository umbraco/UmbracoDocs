...
Now that the basic site is set up, make it multilingual by creating content variations in another language. In this tutorial, you will create a Danish version of the `HomePage`.
...
2. Go to **Languages**.
3. Click **Create**.
4. Select a **Language** from the dropdown list. For example, Danish.
...
8. Disable **Shared across cultures**.

![Allow property editor Language Variants](../../../.gitbook/assets/enable-vary-by-culture-property.png)
...
![Culture and Hostnames](../../../.gitbook/assets/culture-and-hostnames-basic-site-tutorial.png)
...
![Language of Content Tree](../../../.gitbook/assets/language-content-tree.png)
...
3. Click **Open in Split view** to see the content node with each language side by side.
...
6. The **Save and publish** window opens providing the option to publish in one or more languages.

    ![Publishing Variant content](../../../.gitbook/assets/publishing-variant-content.png)
...
4. You will notice the links with the new language domain added to it. If it's not there, you might need to refresh the page.
    ...
    ![Viewing the Language Variant Link](../../../.gitbook/assets/viewing-langvariant-browser.png)
