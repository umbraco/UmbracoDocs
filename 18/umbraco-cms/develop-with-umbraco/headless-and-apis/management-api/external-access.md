...
When consuming the Management API from an external source, you must use the OpenId Connect Client Credentials flow for authorization. Refer to the [API Users](../../../manage-and-publish-content/users-and-members/users/api-users.md) article for details on setting up Client Credentials.
