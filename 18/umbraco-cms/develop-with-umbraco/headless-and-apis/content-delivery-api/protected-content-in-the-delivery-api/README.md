...
{% hint style="info" %}
If you are not familiar with members in Umbraco, read the [Members](../../../../manage-and-publish-content/users-and-members/members.md) article.
{% endhint %}
...
The index can be rebuilt from the [Examine Management dashboard](../../../application-code/examine/examine-management.md).
{% endhint %}
...
Umbraco allows adding external identity providers for both backoffice users and members. The process is documented in detail in the [External Login Providers](../../../../run-in-production/security/external-login-providers.md) article.
...
Learn more about this in the [Dependency Injection](../../../application-code/backend-and-custom-logic/using-ioc.md) article.
{% endhint %}
