...
If however you are [Hijacking an Umbraco route](../../../application-code/backend-and-custom-logic/routing/custom-controllers.md) and specifying your own controller to do the execution, then your partial view location can also be:
