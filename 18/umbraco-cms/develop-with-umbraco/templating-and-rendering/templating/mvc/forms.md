...
1. Using view models, views, controllers, and a handy HtmlHelper extension method called BeginUmbracoForm, see the [Creating Forms](../../../application-code/backend-and-custom-logic/creating-forms.md) article.
