...
See [Core documentation on the interface ICultureDictionary](https://apidocs.umbraco.com/v18/csharp/api/Umbraco.Cms.Core.Dictionary.ICultureDictionary.html).
