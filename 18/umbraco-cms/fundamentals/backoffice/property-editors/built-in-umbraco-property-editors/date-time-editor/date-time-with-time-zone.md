...
To set up a property using this editor, create a new _Data Type_. Select **Date Time (with time zone)** from the list of available property editors.

You will see the configuration options as shown below.

![Date Time with Time Zone property editor configuration](../../../../../.gitbook/assets/date-time-with-time-zone-property-editor-config.png)
...
* **HH:mm** - Displays hours and minutes (e.g., `14:30`).\
  ...
  ![Date Time with Time Zone property editor showing time format in HH:mm format (hours and minutes only)](../../../../../.gitbook/assets/date-time-time-format-hhmm.png)
* **HH:mm:ss** - Displays hours, minutes, and seconds (e.g., `14:30:45`).\
  Use this when you need more precise timing.\
  ![Date Time with Time Zone property editor showing time format in HH:mm:ss format (hours, minutes, and seconds)](../../../../../.gitbook/assets/date-time-time-format-hhmmss.png)
...
* **Custom** - Allows you to define a list of time zones. When you select this option, a dropdown appears. You can search and select from the full IANA time zone list. Add multiple zones to restrict user selection to only the zones you specify.
  * Example:\
    ...
    * `Europe/Copenhagen`\
      ...
      ![Date Time with Time Zone property editor showing custom time zone selection with UTC and Europe/Copenhagen options](../../../../../.gitbook/assets/date-time-with-time-zone-custom.png)
...
![Date Time with Time Zone property editor showing time zone dropdown with filtering functionality as user types](../../../../../.gitbook/assets/date-time-with-time-zone-filtering.png)
...
![Date Time with Time Zone property editor displaying a single time zone as a static label instead of dropdown](../../../../../.gitbook/assets/date-time-with-time-zone-single-time-zone.png)
