...
The Document Picker opens a panel to pick a specific page from the content structure. The value saved is the selected nodes [UDI](../../../develop-with-umbraco/templating-and-rendering/querying/udi-identifiers.md).
...
![Document Picker Content](../../../.gitbook/assets/Content-Picker-Content.png)
