...
![Checkbox Example](../../../.gitbook/assets/emailaddress-datatype.png)

## Content Example

![Single email address content example](../../../.gitbook/assets/EmailAddress-Content.png)
...
See the example below to learn how a value can be added or changed programmatically to an Email-address property. To update a value of a property editor you need the [Content Service](https://apidocs.umbraco.com/v18/csharp/api/Umbraco.Cms.Core.Services.ContentService.html).
