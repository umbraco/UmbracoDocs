...
Stylesheets can be created in the **Settings** section. To learn more about this feature, see the [Stylesheets in the Backoffice](../../../../develop-with-umbraco/templating-and-rendering/design/stylesheets-javascript.md) article.
