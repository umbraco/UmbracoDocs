...
Below, you can find an example of how to set up a custom Style Select menu using an [Umbraco Package Manifest](../../../../extend-your-project/backoffice-extensions/umbraco-package.md) file.
