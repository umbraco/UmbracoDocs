---
description: >-
  Learn how to strengthen the security of your Umbraco installation, and reduce
...
The prerequisite of this to work is that you’re using [IISRewrite](../../develop-with-umbraco/application-code/backend-and-custom-logic/routing/iisrewriterules.md)
