---
description: >-
  Protect the front-end of your Umbraco website with basic authentication using
...
For the full list of configuration options, see the [Basic Authentication Settings](../../develop-with-umbraco/configuration/basicauthsettings.md) article.
...
For details on the available configurations, see the [Service Registration](../../develop-with-umbraco/service-registration.md) article.
