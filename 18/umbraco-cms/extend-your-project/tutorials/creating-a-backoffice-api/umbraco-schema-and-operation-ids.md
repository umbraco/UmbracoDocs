...
If you need more control, you can create a custom operation transformer. See the [Operation IDs](../../server-side-extensions/api-versioning-and-openapi.md#operation-ids) section for an example.
