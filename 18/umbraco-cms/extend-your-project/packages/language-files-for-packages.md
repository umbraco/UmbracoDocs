...
Read the [UI Localization documentation](../backoffice-extensions/foundation/localization.md) to learn in-depth on how you can use languages in your packages and Umbraco in general.
