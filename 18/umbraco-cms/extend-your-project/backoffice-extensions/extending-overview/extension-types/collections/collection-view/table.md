...
| _(manifest columns)_                          | Any columns defined in `meta.columns`, inserted after Name/Description. Values are rendered as strings by default, or via a [Value Summary](../../value-summary.md) when `valueType` is set. |
...
| `valueType` | No       | A [Value Type](../../value-type.md) key. When set, the column renders the value using the matching [Value Summary](../../value-summary.md) instead of a plain string. |
...
{% content-ref url="../../value-type.md" %}
[value-type.md](../../value-type.md)
{% endcontent-ref %}

{% content-ref url="../../value-summary.md" %}
[value-summary.md](../../value-summary.md)
{% endcontent-ref %}
