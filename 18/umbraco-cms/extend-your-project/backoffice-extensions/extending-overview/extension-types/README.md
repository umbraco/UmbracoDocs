---
description: An overview of general extension types available in the Umbraco backoffice.
---
...
### [Property Editor UIs](property-editor-ui/property-editor-uis.md)
...
### [Tip-Tap Extensions](../../../../model-your-content/property-editors/built-in-umbraco-property-editors/rich-text-editor/extensions.md)
...
### [Umbraco Flavored Markup Components](../../../../model-your-content/property-editors/umbraco-flavored-markdown.md)
...
| Type                       | Description                                                                                                                                                                                                                                                                                                                |
| -------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| authProvider               | An authentication provider for [external login](../../../../run-in-production/security/external-login-providers.md).                                                                                                                                                                                                       |
...
| healthCheck                | A health check is a check that can be added to the health check dashboard. Read more about the backend side of [Health Checks](../../../../develop-with-umbraco/configuration/healthchecks.md).                                                                                                                            |
...
| mfaLoginProvider           | This type of login provider is the UI component of [Two-Factor Authentication](../../../../run-in-production/security/two-factor-authentication.md) used to enable/disable the provider.                                                                                                                                   |
| modal                      | A modal dialog. Read more about [Modals](modals/).                                                                                                                                                                                                                                                                         |
| monacoMarkdownEditorAction | A Monaco Markdown Editor action is a button that can be added to the toolbar of the [Markdown Property Editor](../../../../model-your-content/property-editors/built-in-umbraco-property-editors/markdown-editor.md).                                                                                                      |
...
| propertyEditorUi           | A property editor UI is a UI component that can be added to content types. It is used to render the UI of a Data Editor. Read more about [Property Editor UI](property-editor-ui/).                                                                                                                                        |
...
| tiptapExtension            | A Tiptap extension is a component that can be added to the [Rich text editor](../../../../model-your-content/property-editors/built-in-umbraco-property-editors/rich-text-editor/).                                                                                                                                        |
| tiptapToolbarExtension     | A Tiptap toolbar extension is a component that can be added to the toolbar of the [Rich text editor](../../../../model-your-content/property-editors/built-in-umbraco-property-editors/rich-text-editor/).                                                                                                                 |
| tiptapStatusbarExtension   | A Tiptap status bar extension is a component that can be added to the status bar of the [Rich text editor](../../../../model-your-content/property-editors/built-in-umbraco-property-editors/rich-text-editor/).                                                                                                           |
...
| Type       | Description                                                                                                                                                                                            |
| ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| repository | A repository is a class that can be used to interact with a data source. It is used either by context classes or elements directly to interact with the data source. Read more about [Repositories](../../foundation/repositories/README.md). |
...
| Type                    | Description                                                                                                                                                                                                                                                                                                                    |
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| workspace               | A workspace is a component that can be added to an entity type. This is the editor you see, when you edit an entity. Read more about [Workspaces](workspaces/).                                                                                                                                                                |
