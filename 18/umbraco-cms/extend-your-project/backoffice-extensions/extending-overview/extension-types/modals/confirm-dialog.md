...
To see all properties of the `UMB_CONFIRM_MODAL` token, see the [API reference](https://apidocs.umbraco.com/v18/ui-api/interfaces/packages_core_modal.UmbConfirmModalData.html).
