...
The `Umb.DataSourceType.Picker` Data Source Type is used by Property Editors that pick entities, for example, the built-in [Entity Data Picker Property Editor](../../../../../model-your-content/property-editors/built-in-umbraco-property-editors/entity-data-picker.md).
