...
For details on the manifest structure and all available options, see the [Property Editor UI Extension Type](../../extending-overview/extension-types/property-editor-ui/) documentation.
