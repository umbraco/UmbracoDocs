...
Property descriptions and labels can also be localized. They are formatted as Markdown and can contain localization keys using the built-in [Umbraco Flavored Markdown](../../../model-your-content/property-editors/umbraco-flavored-markdown.md) syntax.
