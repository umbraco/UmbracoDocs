---
description: >-
  Learn about notification handlers lifetime, async notification handler and how
  to register the notification handlers.
---
...
{% hint style="info" %}
Learn more about the different ways of registering your handlers and other extensions in the [Dependency Injection](../../../develop-with-umbraco/application-code/backend-and-custom-logic/using-ioc.md) article.
{% endhint %}
