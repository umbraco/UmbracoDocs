...
Getter methods of this service return the current state of a consent, that is the latest [IConsent](https://apidocs.umbraco.com/v18/csharp/api/Umbraco.Cms.Core.Models.IConsent.html) entity that was created.
