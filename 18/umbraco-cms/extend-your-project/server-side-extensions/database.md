...
If building a new solution, you can adopt a new pattern. With this pattern you create and run a similar migration but trigger it in response to a [notification handler](../../develop-with-umbraco/application-code/backend-and-custom-logic/subscribing-to-notifications.md).
