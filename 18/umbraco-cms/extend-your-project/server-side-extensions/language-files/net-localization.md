...
.NET localization has limited use cases in Umbraco, as all backoffice localization is performed with [UI Localization](../../backoffice-extensions/foundation/localization.md).
