...
A field view is assigned to a list view field as part of the list view configuration. For more information, see the [List Views](./#setting-the-view-of-a-field) article.
