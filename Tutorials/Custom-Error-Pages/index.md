...
- Custom [ContentFinders](../../Reference/routing/request-pipeline/IContentFinder/) in your solution, when you (or any package) have a custom `IContentLastChanceFinder` configured, the settings `appSettings.json` will not be used.
