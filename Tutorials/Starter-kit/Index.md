...
* **Lessons:** Do you have a good idea for a lesson? You can submit your idea so someone can write a lesson or contribute by writing your own and submitting it to the [documentation repository](https://github.com/umbraco/UmbracoDocs/issues). It's easy to do, simply follow [this guide](https://github.com/umbraco/Umbraco-CMS/blob/dev-v7/CONTRIBUTING.md).
