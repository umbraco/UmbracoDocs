...
* [Working with generated Models](http://localhost:5000/s/OdQETpqkO0Kcv8KMquKL/reference/templating/modelsbuilder)
* [Concerns when working with Views](http://localhost:5000/s/OdQETpqkO0Kcv8KMquKL/reference/templating/mvc)
* [Different types of Controllers](http://localhost:5000/s/OdQETpqkO0Kcv8KMquKL/implementation/controllers)

## Umbraco-specific MVC concepts

There are two concepts that are Umbraco specific which might prove useful to learn about:

* [Surface Controllers](http://localhost:5000/s/OdQETpqkO0Kcv8KMquKL/reference/routing/surface-controllers)
* [Default routing](http://localhost:5000/s/OdQETpqkO0Kcv8KMquKL/implementation/default-routing/controller-selection)
...
Learn more about composing and components in the [Composing article](http://localhost:5000/s/OdQETpqkO0Kcv8KMquKL/implementation/composing).
...
* [General debugging](http://localhost:5000/s/OdQETpqkO0Kcv8KMquKL/fundamentals/code/debugging)
* [Debugging with SourceLink](http://localhost:5000/s/OdQETpqkO0Kcv8KMquKL/reference/debugging)
