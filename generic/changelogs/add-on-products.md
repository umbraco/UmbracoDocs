...
* Added a [Handling sensitive data in Umbraco Forms](/broken/spaces/Hbkj8mAE5C7ODrOVDnjJ/pages/ad7X0ag97slbwqrjOj8T#handling-sensitive-data-in-umbraco-forms) section in the Security article. ([#6412](https://github.com/umbraco/UmbracoDocs/pull/6412))
* Information on Import Function ([#6415](https://github.com/umbraco/UmbracoDocs/pull/6415))
* Guide: [Creating a Multi-Page Form](/broken/spaces/Hbkj8mAE5C7ODrOVDnjJ/pages/2O5IoVYqfqcUY27G9WGV) ([#6431](https://github.com/umbraco/UmbracoDocs/pull/6431))
{% endtab %}
