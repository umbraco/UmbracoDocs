...
- The 'layout' property is the origin of the data. This object defines the blocks of this property including the order and layout of those.
- The 'data' property is the data of your blocks and is managed by the Model Object therefor it can be ignored for most uses.
