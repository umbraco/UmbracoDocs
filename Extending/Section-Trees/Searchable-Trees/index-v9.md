...
If we have a custom section Tree with alias 'favouriteThingsAlias' (see the [custom tree example](../trees-v9.md)) then we could implement searchability by creating the following C# class in our site:
