...
If we have a custom section Tree with alias 'favouriteThingsAlias' (see the [custom tree example](../Trees/index.md)) then we could implement searchability by creating the following c# class in our site:
