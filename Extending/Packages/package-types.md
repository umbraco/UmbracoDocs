...
:::note
Currently you cannot include media items in a Package Zip file. You will need a custom [package action](Package-Actions/index.md) to install media as part of a package.
:::
