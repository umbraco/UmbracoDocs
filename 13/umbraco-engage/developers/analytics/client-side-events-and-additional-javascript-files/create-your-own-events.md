...
{% hint style="info" %}
Umbraco Engage also ships ready-made event scripts you can include, such as Google Analytics blocker detection. See [Google Analytics Blocker Detection](google-analytics-blocker-detection.md) for an example using this same format.
{% endhint %}
