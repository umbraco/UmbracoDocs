...
![Location tab, located under the Analytics section](<../../.gitbook/assets/engage-analytics-locations (1).png>)
...
![Location table with data](<../../.gitbook/assets/engage-analytics-location-countries (1).png>)
