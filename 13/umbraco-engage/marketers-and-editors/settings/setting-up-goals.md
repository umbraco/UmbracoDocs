...
![Find the Settings dashboard in the Enage section of the backoffice.](<../../.gitbook/assets/engage-settings-overview-of-goals (1).png>)
...
<figure><img src="../../.gitbook/assets/engage-settings-setup-new-goal (1).png" alt=""><figcaption><p>Create a new goal by giving it a name, setting a value and deciding on a set of parameters.</p></figcaption></figure>
