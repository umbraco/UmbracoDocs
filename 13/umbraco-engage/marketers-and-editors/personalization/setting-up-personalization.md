...
![Accessing the 'Personalization' content app for a specific node in Umbraco](<../../.gitbook/assets/engage-personalization-content-app (1).png>)
...
![Overview of applied personalizations with the option to add a personalized variant](<../../.gitbook/assets/engage-personalization-add-personalized-variant (1).png>)
...
![Split-view editor with options to create a personalized variant for the selected segment](<../../.gitbook/assets/engage-personalization-splitview-text (1).png>)
...
![Editing a personalized variant with a different title in the splitview editor](<../../.gitbook/assets/engage-my-first-personalization (1).png>)
...
![Accessing the Personalization section in Engage](<../../.gitbook/assets/engage-personalization-new-personalization (1).png>)
...
![Setting up Personalization](<../../.gitbook/assets/engage-apply-personalization-to-multiple-pages (1).png>)
