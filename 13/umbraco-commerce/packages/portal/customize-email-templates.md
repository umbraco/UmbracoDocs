...
![Overview of the store's email templates settings](../../.gitbook/assets/ucp_email_templates.png)

![Overview of the properties of an email template](../../.gitbook/assets/ucp_email_template_details.png)
