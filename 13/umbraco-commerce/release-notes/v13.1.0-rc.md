...
* **Umbraco.Commerce.Deploy** - Supports the store and shipping method udpates as well as the new locations model.
* **Umbraco.Commerce.Checkout** - Add's support for displaying / selecting shipping rates on the front end. 