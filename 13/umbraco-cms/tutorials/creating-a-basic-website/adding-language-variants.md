...
4.  Select a **Language** from the dropdown list. In this tutorial, we will pick Danish.
    ...
    ![Adding the Danish language](../../.gitbook/assets/adding-danish-language-v11.png)
...
6.  Select a **Fallback Language** from the drop-down list.
    ...
    ![Adding a Fallback language](../../.gitbook/assets/fallback-language-v11.png)
7. Click **Save**.
...
7.  Click **Submit**.
    ...
    ![Allow property editor Language Variants](../../.gitbook/assets/allow-varying-property-editor-v11.png)
...
3.  Add a domain for each hostname, like it's done here:
    ...
    ![Culture and Hostnames](../../.gitbook/assets/culture-and-hostnames-v11.png)
4. Click **Save**.
...
![Language of Content Tree](<../../.gitbook/assets/language-content-tree (1).png>)
...
1.  Go to the **Home Page** node. You will find a language dropdown next to the title at the top:
    ...
    ![Language Variant dropdown](<../../.gitbook/assets/language-dropdown (3).png>)
2.  Click the dropdown and hover over the new language. You will see an **Open in Splitview** option will appear.

    ![Open Language in Splitview](<../../.gitbook/assets/open-in-splitview (3).png>)
3.  Click **Open in Splitview**. In this splitview, we can see the content node with each language side by side.
    ...
    ![Splitview editing](<../../.gitbook/assets/splitview-editing (3).png>)
...
5.  Click **Save and Publish**. The **Ready to Publish** window opens providing the option to publish in one or more languages.
    ...
    ![Publishing Variant content](../../.gitbook/assets/publishing-variant-content-v11.png)
...
4.  You will notice the links with the new language domain added to it. If it's not there, you might need to refresh the page.
    ...
    ![Viewing the Language Variant Link](../../.gitbook/assets/viewing-langvariant-browser-v11.png)
