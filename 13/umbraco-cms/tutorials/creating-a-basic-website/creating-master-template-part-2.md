...
7.  Let's add two fields with the following specifications:
    ...
    ![Content Page Template with Data Fields](<../../.gitbook/assets/figure-35-contact-us-template-with-data-fields-v8 (1).png>)
8. Click **Save**.
...
4.  Select **Simple Content Page** and click **Save**.
    ...
    <figure><img src="../../.gitbook/assets/figure-32-homepage-allowed-child-v8 (1).png" alt=""><figcaption></figcaption></figure>
...
4.  Click the link to view the page.
    ...
    <figure><img src="../../.gitbook/assets/figure-37-viewing-contact-us (1).png" alt=""><figcaption></figcaption></figure>
