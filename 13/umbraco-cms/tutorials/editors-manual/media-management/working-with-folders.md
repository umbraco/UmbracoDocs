...
2.  Click on **•••** where you want to create the folder and select **Folder**.
    ...
    ![Create Folder](<../../../.gitbook/assets/create-folder-v9 (1).png>)
...
3.  Click **Create** to add another media type or drag and drop your files into the **Upload** field.
    ...
    ![Edit Folder](<../../../.gitbook/assets/Edit-folder-v9 (1).png>)
4. Click **Save**.
...
2.  Right-click the folder, and select **Delete**.
    ...
    ![Delete Folder](<../../../.gitbook/assets/Delete-folder-v9 (1).png>)
3. Click **OK**.
...
![Recycle Bin](<../../../.gitbook/assets/mediaRecycle-v9 (1).png>)
...
2.  Select **Restore**.
    ...
    ![Restore Folder](<../../../.gitbook/assets/Restore-Folder-v9 (1).png>)
3. Click **Restore**.
