...
<strong>Smidge is scheduled for removal from Umbraco 14. You can install the package separately if needed.</strong>
...
![Custom Dashboard extended with UI Library Card](<../../../../14/umbraco-cms/tutorials/images/extendedWithUiLibrary (1).png>)
