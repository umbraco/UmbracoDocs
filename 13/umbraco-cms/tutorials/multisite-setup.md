...
![Adding hostnames to the project](<../.gitbook/assets/1-addinghostnames (1).png>)
...
3.  Select **Culture and Hostnames**. option.
    ...
    ![Culture and hostnames](<../.gitbook/assets/2-culturehostnames-v10 (1).png>)
...
<figure><img src="../.gitbook/assets/3-culturehostnamesp2-v10 (1).png" alt=""><figcaption></figcaption></figure>

6\. Click Save and that should do it!

The sites you have should now be available under the hostnames you provided.

![Dolphin site](<../.gitbook/assets/6-dolphins (1).png>) ![Swato site](<../.gitbook/assets/7-swato (1).png>)
