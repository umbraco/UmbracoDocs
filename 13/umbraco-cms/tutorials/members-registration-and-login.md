...
![Partial create](../.gitbook/assets/v8-01-Partial-Macro-Create.png)

Make sure to create this Macro view from available snippets.

![Partial macro snippets](../.gitbook/assets/v8-02-Partial-Macro-Snippets.png)

Start with the Register Member snippet.

![Partial macro register](../.gitbook/assets/v8-03-Partial-Macro-Register.png)
...
![Partial snippets](../.gitbook/assets/v8-04-Partial-Snippets.png)
...
![Macro settings](../.gitbook/assets/v8-05-Macros-Settings.png)
...
![RTE macro](../.gitbook/assets/v8-06-RTE-Macro.png)
...
![RTE macro insert](../.gitbook/assets/v8-07-RTE-Macro-Insert.png)

Save and publish the new page. Now the Register/Login functionality should be rendered on the new page you made.

![Login page frontend](../.gitbook/assets/v8-08-Login-Page-Frontend.png)
...
![Backoffice members](../.gitbook/assets/v8-09-Backoffice-Members.png)
...
![Login partial in navigation](../.gitbook/assets/v8-10-Login-Partial-In-Nav.png)
...
![Login partial frontend](../.gitbook/assets/v8-11-Login-Partial-Frontend.png)
...
2. Select your User.
3. Add the "Sensitive Data" Group. ![Assign User Access group](../.gitbook/assets/v8-17-Assign-User-Access-Group.png)
...
<img src="../.gitbook/assets/v8-18-Approve-Member.png" alt="Approve Member" data-size="original">
...
![New member group](../.gitbook/assets/v8-12-New-Member-Group.png)
...
![Member group assign](../.gitbook/assets/v8-13-Member-Group-Assign.png)
...
![Restrict public access](../.gitbook/assets/v8-14-Restrict-Public-Access.png)
...
![Restrict public access details](../.gitbook/assets/v8-15-Restrict-Public-Access-Details.png)
...
![Protected content](../.gitbook/assets/v8-16-Protected-node.png)
