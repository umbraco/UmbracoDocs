...
5. Select **Add Custom View** in **Custom View** and browse to the **custom.html** file. ![Browse View Location](<../.gitbook/assets/View-location (1).png>)
6. Click **Submit**.
...
5.  Select **Add Stylesheet** and browse to **style.css**.
    ...
    <figure><img src="../.gitbook/assets/Stylesheet-location (1).png" alt=""><figcaption></figcaption></figure>
...
9.  Restart your application. Now, when you head over to the **Product** page in the **Content** section and hover over the block you will notice the settings option.
    ...
    <figure><img src="../.gitbook/assets/Settings-option (1).png" alt=""><figcaption></figcaption></figure>
10. Click on **Edit Settings** and you can see the **Block Theme** options we created.

    <figure><img src="../.gitbook/assets/Feature-Options-1 (1).png" alt=""><figcaption></figcaption></figure>
11. **Select a Theme** of your choice and click on **Submit** to see the changes reflect on your block.

    <figure><img src="../.gitbook/assets/Block-settings-1 (1).png" alt=""><figcaption></figcaption></figure>
