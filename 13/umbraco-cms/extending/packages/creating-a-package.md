...
3.  Select the `Create package` button.
    ...
    ![Buttons to select for creating a package schema in the backoffice](<../../.gitbook/assets/creating-package-menu-v9 (1).png>)
...
![Content of a ZIP package](<../../.gitbook/assets/zip-package-v9 (1).png>)
...
![Content of an empty package](<../../.gitbook/assets/empty-package-from-template (1).png>)

Apart from the project file, the **App\_Plugins** folder includes an empty `package.manifest`, which is replaced with the one created in the [Creating a Custom Dashboard Tutorial](../../tutorials/creating-a-custom-dashboard/). More importantly, it also contains a `build/CustomWelcomeDashboard.targets` file.
...
![App\_Plugins with dashboard files](<../../.gitbook/assets/app-pligins-contents (1).png>)
...
![Package properties](<../../.gitbook/assets/package-properties (1).png>)
...
![Attended package install](../../.gitbook/assets/package-install-attended.png)
