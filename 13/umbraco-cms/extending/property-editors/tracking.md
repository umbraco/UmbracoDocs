...
2.  Select a media item and click the **Info** tab.
    ...
    ![Viewing media references](<../../.gitbook/assets/media-references-v9 (1).png>)
...
2.  Under the **Relation Types** folder, select **Related Document** relations and click **Relations**.
    ...
    ![Viewing document references](<../../.gitbook/assets/document-references-v9 (1).png>)
...
4.  Navigate to the **Info** tab.
    ...
    ![Viewing Data Type references](<../../.gitbook/assets/data-types-references-v10 (1).png>)
