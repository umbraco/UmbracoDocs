...
![Adding a language](<../../.gitbook/assets/languages_v10 (1).png>)
...
3.  Toggle **Allow vary by culture**.
    ...
    <figure><img src="../../.gitbook/assets/allow-variance_v10 (1).png" alt=""><figcaption></figcaption></figure>

To allow a property on the Document Type to be varied it will have to be enabled for the property:

![Allowing variance on properties](<../../.gitbook/assets/varying-properties_v10 (1).png>)
...
2.  To the right of the content name there is now a dropdown where you can select a language. You can also open a split view so you can see two languages at once.
    ...
    ![Allowing variance on properties](<../../.gitbook/assets/varying-content_v10 (1).png>)
...
![How an invariant property looks when it is locked](<../../.gitbook/assets/invariant-property-locked (1).png>)
...
![Assign access to all or individual languages on th User Group](../../.gitbook/assets/Assign-Access-Languages.png)
