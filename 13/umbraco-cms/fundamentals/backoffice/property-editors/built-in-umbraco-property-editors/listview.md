...
![List view example](<../../../../.gitbook/assets/listview (1).png>)
...
![Enable List view example](<../../../../.gitbook/assets/enable-listview (1).png>)

## Settings

![List view settings example](<../../../../.gitbook/assets/list-view-settings1-v10 (1).png>)

![List view settings example 2](<../../../../.gitbook/assets/list-view-settings2-v10 (1).png>)
...
![List view property example](<../../../../.gitbook/assets/listview-property (1).png>)

![List view property example](<../../../../.gitbook/assets/listview-property-dropdown (1).png>)
...
![List icon example](<../../../../.gitbook/assets/list-icon (1).png>)
...
This example uses a generic field on a child item and displays it in the list. ![List view content example email](<../../../../.gitbook/assets/listview-content-example-email-settings (1).png>)

The `{{ value }}` will take the value of the Email property and display it in the list, as shown on the image below.

![List view content example email](<../../../../.gitbook/assets/listview-content-example-email (1).png>)
...
![List view member picker](<../../../../.gitbook/assets/member-picker (1).png>)
...
![List view member picker](<../../../../.gitbook/assets/member-picker-settings (1).png>)

This will take the value picked up by the member picker. ![List view member picker](<../../../../.gitbook/assets/picked-member (1).png>)

And display it in the listview. Shown in the example below: ![List view member picker](<../../../../.gitbook/assets/list-member-picked (1).png>)

### Other examples

![List view other examples](<../../../../.gitbook/assets/others (1).png>) ![List view other examples](<../../../../.gitbook/assets/others-result (1).png>)
