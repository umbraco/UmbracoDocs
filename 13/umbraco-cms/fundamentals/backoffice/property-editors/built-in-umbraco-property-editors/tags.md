...
![Data Type Definition Example](<../../../../.gitbook/assets/Tags-DataType-v10 (1).png>)
...
![CSV tags example](<../../../../.gitbook/assets/Csv-example-v8 (1).png>)

### JSON tags

![JSON tags example](<../../../../.gitbook/assets/Json-example-v8 (1).png>)

### Tags typeahead

Whenever a tag has been added it will be visible in the typeahead when you start typing on other pages.

![Tags typeahead example](<../../../../.gitbook/assets/Typeahead-v8 (1).png>)
