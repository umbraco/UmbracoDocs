...
2.  Check the log messages in the **Log Viewer** under the **Settings** section.
    ...
    ![Log Viewer](<../../.gitbook/assets/log-viewer (1).png>)
3. Search **All Logs**.

If everything is set up correctly you will see your custom log messages.

![Messages in Log](<../../.gitbook/assets/log-messages (1).png>)
...
* For further details on Notifications in Umbraco, see the [Using Notifications](../../reference/notifications/) article.
