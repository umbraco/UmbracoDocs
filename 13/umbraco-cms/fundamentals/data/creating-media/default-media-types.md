...
Notes: 
* It is necessary to set the permission of each of those media types to Allow at Root
* The Folder Media Type needs to have new data types allowed as children
