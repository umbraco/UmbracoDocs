...
![Parent, Siblings & Children](<../../.gitbook/assets/parent-siblings-children (1).png>)
...
![Relation Types Tree](../../.gitbook/assets/relation-types-tree.png)
...
![Default Relation Types](../../.gitbook/assets/default-relation-types.png)
...
![Create Relation Type](<../../.gitbook/assets/create-relation-type (1).png>)
...
5.  Choose the different types for each entity (**Parent** and **child**) from the drop-down list.
    ...
    ![Member Images](<../../.gitbook/assets/member-images (1).png>)
...
7.  Click **Create** and you'll see your new Relation Type created in the Relation Types folder. You can see the 'Alias' that you'll need to make note of when working with Relations.
    ...
    ![Member Images](<../../.gitbook/assets/relation-alias (1).png>)
...
![View Relations](<../../.gitbook/assets/view-relations (1).png>)
