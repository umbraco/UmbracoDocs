...
![Creating a new stylesheet](<../../.gitbook/assets/1-creating-stylesheet (1).png>)
...
![Stylesheet Rich Text Editor (RTE)](../../.gitbook/assets/2-rte-editor.png)

The rules you create in the Rich Text Editor section will carry over to the Code tab.

![Stylesheet RTE tab](../../.gitbook/assets/3-rte-editor-p2.png) ![Stylesheet Code tab](../../.gitbook/assets/3-rte-editor-p3.png)
...
![Linking CSS in template](../../.gitbook/assets/4-link-css-v9.png)
...
![Creating a new JavaScript](<../../.gitbook/assets/8-create-js (1).png>)

From here you can add a new JavaScript file, or a new folder.

Add a new JavaScript file and write your code:

![Sample JS script](../../.gitbook/assets/9-myscript.png)
...
![Reference the script in template](../../.gitbook/assets/10-reference-script-v9.png)
