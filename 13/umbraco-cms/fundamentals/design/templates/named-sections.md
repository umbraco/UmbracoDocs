...
2.  Navigate to a template and click **Sections**.
    ...
    <figure><img src="../../../.gitbook/assets/Sections-option (1).png" alt=""><figcaption></figcaption></figure>
3.  Select **Define a named section** and enter the **Section Name**.

    <figure><img src="../../../.gitbook/assets/Define-named-section.png" alt=""><figcaption></figcaption></figure>
4. Click **Submit**.
...
3.  Select **Render a named section** and enter the **Section Name**.
    ...
    <figure><img src="../../../.gitbook/assets/Render-named-sections.png" alt=""><figcaption></figcaption></figure>
