...
<img src="../../../.gitbook/assets/ModelsBuilderDisabledOnProduction (1).png" alt="" data-size="original">

\
Also, templates cannot be edited on live environment as runtime compilation is not enabled and is set to Production.

<img src="../../../.gitbook/assets/TemplatedCannotBeEditedWhenRuntimeIsProduction (1).png" alt="" data-size="original">
{% endhint %}
