...
3.  Click the extensions menu at the bottom on the left side. Then search for **C#** and install it.
    ...
    ![Visual Studio Code install extension](<../../../.gitbook/assets/Marketplace (1).jpg>)
...
![Fresh Umbraco installation](<../../../.gitbook/assets/VS_Code_Explorer (1).png>)
...
![Creating launch.json file](<../../../.gitbook/assets/Create_LaunchJson_file (1).jpg>)

This will prompt a menu to appear, select **.NET 5+ and .NET Core**:

<figure><img src="../../../.gitbook/assets/Prompt_Menu (1).jpg" alt=""><figcaption><p>Prompt Menu</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/Dropdown_option (1).jpg" alt=""><figcaption><p>Green Play button options</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/launchJson (1).jpg" alt=""><figcaption></figcaption></figure>
...
![Web Installer - Lets Get Started](<../../../.gitbook/assets/Install_Umbraco (1).jpg>)
