...
![Insert Image Carousel](../../../.gitbook/assets/image-carousel-macro-v8.PNG)

Define the parameters

![Define the parameters](../../../.gitbook/assets/macro-parameter-editor-v8.png)

Using in a Rich Text Area

A Rich Text Editor should be enabled with macros in the toolbar to allow inserting macros.

![Enable macro toolbar in Rich Text Area](../../../.gitbook/assets/rte-macro.png)

Rich Text Area with macro toolbar option

![Macro toolbar option in Rich Text Area](../../../.gitbook/assets/rte-macro-toolbar.png)

Insert the macro into a Rich Text Area

![Insert the macro into a Rich Text Area](../../../.gitbook/assets/pick-images-for-macro-example-v8.png)
