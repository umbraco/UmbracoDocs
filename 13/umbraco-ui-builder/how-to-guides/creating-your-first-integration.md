---
description: >-
  Creating your first integration with Umbraco UI Builder, the backoffice UI
  builder for Umbraco.
---
...
![People list view](../.gitbook/assets/people_listview.png)

![People editor](../.gitbook/assets/people_editor.png)
