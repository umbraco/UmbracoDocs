---
description: >-
  Configuring field views in Umbraco UI Builder, the backoffice UI builder for
  Umbraco.
---
...
A field view is assigned to a list view field as part of the list view configuration. For more information you can check the [List View Documentation](./#setting-the-view-of-a-field).
