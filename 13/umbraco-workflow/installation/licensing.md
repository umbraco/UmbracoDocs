...
If you have upgraded from an earlier v13 release and encounter license validation issues, ensure the product is id `Umbraco.Workflow`, not `UmbracoWorkflow`.  
