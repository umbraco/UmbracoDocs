...
![Tasklist with approval thresholds](../.gitbook/assets/tasklist-with-approval-thresholds.png)
...
![Setting approval threshold for individual workflow stages](../.gitbook/assets/approval-flow-with-thresholds.png)
