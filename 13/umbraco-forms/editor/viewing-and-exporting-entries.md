...
![Entries viewer](../.gitbook/assets/EntriesViewer.png)
...
4.  The Export dialog opens. Choose a format such as Microsoft Excel to export the Form records to.
    ...
    <figure><img src="../.gitbook/assets/ExportAllDialog.png" alt=""><figcaption></figcaption></figure>
5. Click **Done**.
...
![Record bulk actions](../.gitbook/assets/BulkActions.png)
