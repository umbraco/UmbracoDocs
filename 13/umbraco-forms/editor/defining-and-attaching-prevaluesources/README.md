...
![Prevalue source tree](../../.gitbook/assets/prevaluesourcetree.png)
...
5.  Select the type of prevalue source from the **Type** drop-down. For more information on the different default types, see the [Overview of the Prevalue Source Types](prevalue-source-types.md) article.
    ...
    ![Choose type](../../.gitbook/assets/choosetype.png)

### Configuring the Prevalue Source

Depending on the **Type** you choose, you'll need to provide some additional settings:

1. In this walk-through, we will select **Get values from textfile** from the **Type** drop-down. ![Type settings](../../.gitbook/assets/typesettings.png)
...
![Prevalues with captions](../../.gitbook/assets/Prevalues-with-caption.png)
...
![Prevalue cache options](../../.gitbook/assets/prevalue-cache-options.png)
...
![Prevalue source](../../.gitbook/assets/FieldPrevalueSource.png)
