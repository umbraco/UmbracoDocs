...
3.  Click **Settings** in the top-right corner of the screen.
    ...
    ![Form settings dialog](../../.gitbook/assets/FormSettings.png)
...
![Form settings Store Records](../../.gitbook/assets/Store-Records.png)

### Captions

Customize the labels of the **Submit**, **Next**, and **Previous** buttons used in your Form.

![Form settings stylesheet](../../.gitbook/assets/FormSettingsCaptions-v9.png)
...
![Form settings stylesheet](../../.gitbook/assets/FormSettingsStyling.png)

### Validation

Define a message that is displayed when a field is mandatory, when a value is not supplied, or when the value is invalid.

![Form settings validation](../../.gitbook/assets/FormSettingsValidation.png)
...
![Form settings Moderation](../../.gitbook/assets/FormSettingsModeration.png)
...
![Form settings Date Retentions](../../.gitbook/assets/FormSettingsDataRetention.png)
