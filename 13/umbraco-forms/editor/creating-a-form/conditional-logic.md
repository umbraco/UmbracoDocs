...
![Example Form](../../.gitbook/assets/ExampleForm.png)
...
2.  Select **Enable Conditions** in the **Conditions** section.
    ...
    <figure><img src="../../.gitbook/assets/EnableConditions-v9.png" alt=""><figcaption></figcaption></figure>
3.  Enabling the condition field displays more options:

    <figure><img src="../../.gitbook/assets/conditions-v9.png" alt=""><figcaption></figcaption></figure>
...
![Setup rule](../../.gitbook/assets/conditions-v9.png)
...
![See conditions in the Forms designer](../../.gitbook/assets/exampleBackoffice-v9.png)

## Result

When both the conditions have been set as shown above, this is how it will look on the frontend:

![Frontend Example](../../.gitbook/assets/exampleFrontend-v9.png)
