...
{% openapi src="../.gitbook/assets/umbraco_forms_swagger.json" path="/umbraco/forms/api/v1/definitions/{id}" method="get" %}
[umbraco_forms_swagger.json](../.gitbook/assets/umbraco_forms_swagger.json)
{% endopenapi %}

{% openapi src="../.gitbook/assets/umbraco_forms_swagger.json" path="/umbraco/forms/api/v1/entries/{id}" method="post" %}
[umbraco_forms_swagger.json](../.gitbook/assets/umbraco_forms_swagger.json)
{% endopenapi %}
