...
![Export dialog](../../.gitbook/assets/tree-export-dialog.png)

When doing a workspace export, you also have the option to include _all_ schema in the export (introduced in Deploy 13.3), regardless of whether it is in use by any content.

![Workspace export dialog](../../.gitbook/assets/workspace-export-dialog.png)
...
![Import dialog](../../.gitbook/assets/import-dialog.png)
...
![Import dialog step 2](../../.gitbook/assets/import-dialog-2.png)
...
![Import dialog step 3](../../.gitbook/assets/import-dialog-3.png)
