...
* **Works from either Copilot surface.** The same agent and tools answer from the Copilot sidebar and from Copilot Workspace. See [Asking Engage Questions](using-umbraco-engage-ai/asking-engage-questions.md).
...
* [Installation](getting-started/installation.md). Install the packages and set up an agent.
* [Tools](getting-started/tools.md). The full list of tools and what each one answers.
* [Asking Engage Questions](using-umbraco-engage-ai/asking-engage-questions.md). Example prompts, from either Copilot surface.
* [Example: A Marketer Agent](using-umbraco-engage-ai/example-marketer-agent.md). Profile, instructions, context, and a guardrail, put together as one configuration to copy.
