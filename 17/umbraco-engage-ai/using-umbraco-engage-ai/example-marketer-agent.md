---
description: >-
  A complete, ready-to-use agent configuration: profile, instructions, context,
  and a guardrail, as one example to copy.
---

# Example: A Marketer Agent

[Installation](../getting-started/installation.md) walks through each piece mechanically. This page pulls them together into one working example, a Marketer Agent on Anthropic Claude. It adds the context and guardrail that make its answers noticeably better and safer, not only functional.

## Profile

An [Engage Anthropic Chat Profile](../getting-started/installation.md#step-3-create-a-profile) on a current Claude model.

## Instructions

The same starting point from [Installation](../getting-started/installation.md#step-4-create-an-agent):
...
1. Create the profile and connection ([Installation](../getting-started/installation.md), Steps 2 and 3).
2. Create the agent with the Instructions above ([Installation](../getting-started/installation.md), Step 4), selecting that profile.
...
4. Grant it the **Engage Read** permission and attach the Input PII Redaction guardrail, both under **Governance** ([Installation](../getting-started/installation.md#step-5-grant-it-access-to-the-engage-tools)).
5. Attach the agent to whichever surface(s) you want it available on ([Installation](../getting-started/installation.md#step-6-make-the-agent-available-where-you-want-it)).

None of this is required to get a working agent. A profile, a granted permission, and a short set of Instructions is enough, as [Installation](../getting-started/installation.md) shows. This is what a more deliberately configured one looks like.
