...
5. Optionally attach a **Context**, a reusable resource injected into every request. Useful for things like tone-of-voice rules; see [Example: A Marketer Agent](../using-umbraco-engage-ai/example-marketer-agent.md) for a worked example.
6. Click **Save**.
...
See [Asking Engage Questions](../using-umbraco-engage-ai/asking-engage-questions.md) for example prompts, from either surface.
