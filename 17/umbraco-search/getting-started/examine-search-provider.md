...
The Examine search provider automatically applies the [Examine directory configuration](../../umbraco-cms/reference/configuration/examinesettings) from Umbraco CMS.
