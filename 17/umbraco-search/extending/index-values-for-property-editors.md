...
[This list](../getting-started/getting-started/built-in-property-editors.md) shows how the default Umbraco property editors transform their values to index data.
