...
* The [`SystemFieldsContentIndexer`](https://github.com/umbraco/Umbraco.Cms.Search/blob/main/src/Umbraco.Cms.Search.Core/Services/ContentIndexing/Indexers/SystemFieldsContentIndexer.cs) gathers all [system fields](../getting-started/getting-started/system-fields.md).
