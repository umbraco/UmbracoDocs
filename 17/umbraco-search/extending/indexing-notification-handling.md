...
{% hint style="warning" %}
Be careful if you change or remove any of the [system fields](../getting-started/getting-started/system-fields.md), as this might corrupt the index.
{% endhint %}

In the following example, the content being indexed might contain a `length` field. This is a radio button list property, and thus it [produces keywords](../getting-started/getting-started/built-in-property-editors.md) for filtering and faceting.
