...
You can define a dashboard by calling one of the `AddDashboard` methods on a [`SectionConfigBuilder`](sections/) or a [`WithSectionConfigBuilder`](sections/#extending-existing-sections) instance.
