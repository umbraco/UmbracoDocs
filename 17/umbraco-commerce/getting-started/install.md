...
* [NuGet Package Installation](install.md#nuget-package-installation)
* [Visual Studio Installation](install.md#visual-studio-installation)
...
Once Umbraco Commerce is installed, you can find it in the Umbraco backoffice under the **Settings** and **Content** sections. To access the **Commerce** section, additional configuration is required. For more details, see the [Configuration](umbraco-configuration.md) article.
