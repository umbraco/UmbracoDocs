...
The `AddUnique` method ensures that your custom generator replaces the default `IOrderNumberGenerator`, overriding both the automatic selection system and the built-in generators. For more details on dependency injection, see the [Dependency Injection](https://github.com/umbraco/UmbracoDocs/blob/main/17/umbraco-commerce/how-to-guides/dependency-injection.md) article.
...
* [Dependency Injection](https://github.com/umbraco/UmbracoDocs/blob/main/17/umbraco-commerce/how-to-guides/dependency-injection.md) - Learn more about registering services in Umbraco Commerce
