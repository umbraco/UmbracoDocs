...
![The interface when signing up for a Shipmondo account.](../../.gitbook/assets/shipmondo_signup.png)

3. Head to the [Shipmondo Login page](https://app.shipmondo.com/account/login/).
4. Sign in to your account.

![The interface when signing in to your Shipmondo account.](../../.gitbook/assets/shipmondo_login.png)
...
![The interface when accessing your Shipmondo API keys.](../../.gitbook/assets/shipmondo_apikeys.png)
