...
![Tax Calculation Methods](<../../.gitbook/assets/tax-calculation-methods (1).png>)

2. Click on the **Create Tax Calculation Method** button.
3. Choose a **Sales Tax Provider** from the list.

![Create Tax Calculation Method](<../../.gitbook/assets/pick-sales-tax-provider (1).png>)

4. Enter the **Tax Calculation Method Name** and **Alias**.
5. Configure the **Tax Calculation Method** settings.

![Edit Tax Calculation Method](<../../.gitbook/assets/tax-calculation-method-settings (1).png>)
...
![Country Tax Calculation Methods](<../../.gitbook/assets/country-tax-calculation-method (1).png>)
...
![Tax Class Tax Codes](<../../.gitbook/assets/tax-class-country-region-settings-modal (1).png>)
...
![Prices Inclusive of Tax Warning](<../../.gitbook/assets/store-prices-include-tax-warning (1).png>)
