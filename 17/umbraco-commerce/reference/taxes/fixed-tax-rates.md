...
![Store Default Tax Class](<../../.gitbook/assets/store-default-tax-class (1).png>)
...
![Product Tax Class](<../../.gitbook/assets/product-tax-class (1).png>)
