---
description: Customize the Content Delivery API's response for custom property editors.
---
...
This article will not dive into the details of creating a custom property editor for Umbraco. Guidance on that can be found in these articles: [Creating a Property Editor](../../../extend-your-project/tutorials/creating-a-property-editor/) and [Property Value Converters](../../../extend-your-project/backoffice-extensions/property-editors/property-value-converters.md).
...
The `IsConverter()` and `GetPropertyValueType()` methods are inherited from the `PropertyValueConverterBase` class, which is covered in the [Property Value Converters](../../../extend-your-project/backoffice-extensions/property-editors/property-value-converters.md) article.
