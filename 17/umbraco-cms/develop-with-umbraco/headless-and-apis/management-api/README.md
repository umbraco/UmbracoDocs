...
Umbraco ships with Swagger to document the Management API. Swagger and the Swagger UI are based on [Swashbuckle.AspNetCore](https://github.com/domaindrivendev/Swashbuckle.AspNetCore/) and is available at `{yourdomain}/umbraco/swagger`.&#x20;

{% hint style="info" %}
For security reasons, both are disabled in production environments. If you get no response at `{yourdomain}/umbraco/swagger`, confirm you're testing against a non-production environment.
{% endhint %}
