...
3. Choose **Create**.
4. Select **Empty partial view**.
5. Enter a partial view name.
6. Click the **Save** button. You will now see the partial view markup in the backoffice editor.

<figure><img src="../../../.gitbook/assets/Created-partial-view.png" alt="Created partial view"><figcaption><p>Created partial view</p></figcaption></figure>
...
2. Click **...** next to the **Partial Views** folder.
3. Choose **Create**.
4. Select **Empty partial view from snippet**.
...
<figure><img src="../../../.gitbook/assets/Created-partial-view-from-snippet.png" alt=""><figcaption><p>Created partial view from snippet</p></figcaption></figure>
...
<div align="center"><figure><img src="../../../.gitbook/assets/Created-folder.png" alt="Created folder"><figcaption><p>Created folder</p></figcaption></figure></div>
...
* [Using MVC Partial Views in Umbraco](../templating/mvc/partial-views.md)
