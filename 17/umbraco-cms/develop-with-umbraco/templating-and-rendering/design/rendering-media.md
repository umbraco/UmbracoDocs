...
_Templates (Views) can access items in the_ [_Media library_](../../../model-your-content/content-types-and-structure/data/creating-media/) _to assist in displaying rich content like galleries_.
...
But wait a second, Umbraco comes with [Models Builder](../templating/modelsbuilder/). This means that you can use strongly typed models for your media items if Models Builder is enabled (which it is by default).
...
When working with the Image Cropper for an image the `GetCropUrl` extension method is used to retrieve cropped versions of the image. Details of the Image Cropper property editor and other examples of using it can be found in the [Image Cropper article](../../../model-your-content/property-editors/built-in-umbraco-property-editors/image-cropper.md). The following is an example to help you get started with the Image Cropper.
...
* [Creating a Media Type](../../../model-your-content/content-types-and-structure/data/creating-media/#creating-a-media-type)
