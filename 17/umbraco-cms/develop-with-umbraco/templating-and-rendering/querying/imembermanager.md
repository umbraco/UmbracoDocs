...
{% hint style="info" %}
For the full list of methods, see the [IMemberManager Interface API Documentation](https://apidocs.umbraco.com/v17/csharp/api/Umbraco.Cms.Core.Security.IMemberManager.html#methods).
{% endhint %}
...
The recommended way is to create a [Controller](../../application-code/backend-and-custom-logic/controllers.md) or Service and inject `IMemberManager` in the constructor:
