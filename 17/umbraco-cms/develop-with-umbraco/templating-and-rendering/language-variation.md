---
description: >-
  Language variants allow you to have different variations of content based on
  the language culture. Learn how to use them in this section.
---
...
* [Getting started with Language Variants](../../model-your-content/content-types-and-structure/backoffice/variants.md)
* [Rendering variant values](design/rendering-content.md)
...
The challenge arises when trying to display all values of an IPublishedContent model in a specific culture from a "current culture"-less context, like a [`SurfaceController`](../application-code/backend-and-custom-logic/routing/surface-controllers/).
