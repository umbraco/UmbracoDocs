...
This has been moved to a separate article: [Create a custom maintenance page](../../run-in-production/tutorials/create-a-custom-maintenance-page.md).
{% endhint %}
...
It is also possible to set up a 404 error page programmatically using `IContentLastChanceFinder`. To learn more about `IContentLastChanceFinder`, read the [Custom Routing](../../extend-your-project/server-side-extensions/custom-routing/) article. Use this approach only if you need dynamic logic, multi-tenant routing, or other custom behavior.
...
* Custom [ContentFinders](../application-code/backend-and-custom-logic/routing/request-pipeline/icontentfinder.md) in your solution,
