...
{% hint style="info" %}
If the language you need does not appear in the dropdown, see the [Adding Additional Languages](../../extend-your-project/server-side-extensions/language-files/adding-additional-languages.md) article.
{% endhint %}
...
{% hint style="info" %}
To change the default backoffice language, update the `Umbraco:CMS:Global:DefaultUILanguage` value in the `appsettings.json` file. For more information, see the [Global Settings](../configuration/globalsettings.md) article.
{% endhint %}
...
For more information, see the [Using fall-back methods](../templating-and-rendering/design/rendering-content.md#using-fall-back-methods) article.
