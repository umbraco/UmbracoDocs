...
For sites with stricter requirements, it is possible to opt-out of both options globally, see [ContentSettings](contentsettings.md#content-version-cleanup-policy) and by Document Type.
...
1.  Open rollback modal.
    ...
    <figure><img src="../../.gitbook/assets/prevent-cleanup-part-1.png" alt=""><figcaption></figcaption></figure>
2.  Click **Prevent cleanup** button for each important version.

    <figure><img src="../../.gitbook/assets/prevent-cleanup-part-2.png" alt=""><figcaption></figcaption></figure>
