...
1. [Create segments](outbound-pipeline.md#id-1.-create-segments)
2. [Create paths](outbound-pipeline.md#id-2.-create-paths)
3. [Create URLs](outbound-pipeline.md#id-3.-creating-urls)
...
A common use case is providing external preview environments for headless sites. See [Additional preview environments support](../../../../headless-and-apis/content-delivery-api/additional-preview-environments-support.md) for a complete example.
