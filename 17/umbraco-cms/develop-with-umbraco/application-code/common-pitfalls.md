...
For more information about consuming and registering your own dependencies have a look at the [Dependency Injection](backend-and-custom-logic/using-ioc.md) documentation.
...
You can read more about this in the [Understanding and Extending Models Builder documentation](../templating-and-rendering/templating/modelsbuilder/understand-and-extend.md)
