...
For example using a custom [Default Controller](../application-code/backend-and-custom-logic/routing/controller-selection.md#change-the-default-controllers) you can add the ResponseCache attribute to the `Index` method
