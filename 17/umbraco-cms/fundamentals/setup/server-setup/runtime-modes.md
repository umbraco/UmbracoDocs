...
<img src="../../../../../13/umbraco-cms/.gitbook/assets/ModelsBuilderDisabledOnProduction.png" alt="" data-size="original">

\
Also, templates cannot be edited on live environment as runtime compilation is not enabled and is set to Production.

<img src="../../../../../13/umbraco-cms/.gitbook/assets/TemplatedCannotBeEditedWhenRuntimeIsProduction.png" alt="" data-size="original">
{% endhint %}
