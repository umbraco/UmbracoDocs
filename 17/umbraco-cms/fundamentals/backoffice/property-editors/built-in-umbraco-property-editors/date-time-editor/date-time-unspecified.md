...
To set up a property using this editor, create a new _Data Type_ and select **Date Time (Unspecified)** from the list of available property editors.

You will see the configuration options as shown below.

![Date Time Unspecified property editor configuration](../../../../../.gitbook/assets/date-time-unspecified-property-editor-config.png)
...
* **HH:mm** - Displays hours and minutes (e.g., `14:30`).\
  ...
  ![Date Time Unspecified property editor showing time format in HH:mm format (hours and minutes only)](../../../../../.gitbook/assets/date-time-time-format-hhmm.png)
* **HH:mm:ss** - Displays hours, minutes, and seconds (e.g., `14:30:45`).\
  Use this when you need more precise timing.\
  ![Date Time Unspecified property editor showing time format in HH:mm:ss format (hours, minutes, and seconds)](../../../../../.gitbook/assets/date-time-time-format-hhmmss.png)
...
![Date Time Unspecified property editor interface](../../../../../.gitbook/assets/date-time-unspecified-editor.png)
