...
* Category **Security**
  ...
  * **Imaging HMAC Secret Key** - verifies the presence of a configured imaging [HMAC secret key](../../reference/configuration/imagingsettings.md). The setting can be found under `Umbraco:CMS:Imaging:HMACSecretKey` in the `appsettings.json` file
* Category **Services**
