...
Both implementations do the same job of converting standard markdown into HTML, but there are some subtle differences in the output produced.
...
Alternatively, the interface itself can be implemented directly so you can use the library and custom behavior you prefer:
