...
We will not dive into the details of creating a custom property editor for Umbraco in this article. If you need guidance on that, please refer to the [Creating a Property Editor](../../tutorials/creating-a-property-editor/) and [Property Value Converters](../../customizing/property-editors/property-value-converters.md) articles.
...
{% include "../../../../16/umbraco-cms/.gitbook/includes/obsolete-warning-snapshot.md" %}
