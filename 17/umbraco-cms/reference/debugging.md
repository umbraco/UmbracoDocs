...
3.  Click **OK** to save the changes.
    ...
    ![Visual Studio 2019 Debug Settings for SourceLink](../.gitbook/assets/VS19-enable-sourcelink.png)
...
* Prompt will appear and the original source code file is fetched directly from GitHub. ![Visual Studio 2019 SourceLink dialog](../.gitbook/assets/VS19-sourcelink-prompt.png)
