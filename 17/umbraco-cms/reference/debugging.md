...
3.  Click **OK** to save the changes.
    ...
    ![Visual Studio 2019 Debug Settings for SourceLink](../../../16/umbraco-cms/reference/images/VS19-enable-sourcelink.png)
...
* Prompt will appear and the original source code file is fetched directly from GitHub. ![Visual Studio 2019 SourceLink dialog](../../../16/umbraco-cms/reference/images/VS19-sourcelink-prompt.png)
