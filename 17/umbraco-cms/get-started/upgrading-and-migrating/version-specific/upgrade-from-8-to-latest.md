---
description: Learn how to upgrade your Umbraco 8 project to Umbraco 10.
---
...
Read more about these changes in the [IPublishedContent](../../../develop-with-umbraco/templating-and-rendering/querying/ipublishedcontent/) section of the Umbraco CMS documentation.
...
{% hint style="info" %}
For more information on the correct namespaces or custom code, you can find the references in the [API Documentation](../../../extend-your-project/server-side-extensions/api-documentation.md) article.
{% endhint %}
