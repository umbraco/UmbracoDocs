...
For more information on migrating from macros to using blocks in the Rich Text Editor, see the [Migrating Macros](find-your-upgrade-path/migrating-macros.md) article.
