...
* [Key Concepts](ai/concepts/README.md)
  ...
  * [Agent Skills](ai/concepts/agent-skills.md)
...
* [Base MCP](ai/base-mcp/README.md)
  * [Create Umbraco MCP Server](ai/base-mcp/create-umbraco-mcp-server/README.md)
  ...
  * [MCP Server SDK](ai/base-mcp/sdk/README.md)
    * [Configuration](ai/base-mcp/sdk/configuration.md)
    * [Constants](ai/base-mcp/sdk/constants.md)
    * [Tool Authoring](ai/base-mcp/sdk/tool-authoring.md)
    * [Tool Filtering](ai/base-mcp/sdk/tool-filtering.md)    
    * [API Helpers](ai/base-mcp/sdk/api-helpers.md)
    * [MCP Chaining](ai/base-mcp/sdk/mcp-chaining.md)
    * [Testing and Evals](ai/base-mcp/sdk/testing.md)
    * [Coverage Tracking](ai/base-mcp/sdk/coverage-tracking.md)
  * [Hosted MCP](ai/base-mcp/hosted-mcp/README.md)
    * [Umbraco Setup](ai/base-mcp/hosted-mcp/umbraco-setup.md)
    * [Manual Setup](ai/base-mcp/hosted-mcp/manual-setup.md)    
    * [Deployment](ai/base-mcp/hosted-mcp/deployment.md)
    * [Local Development Setup](ai/base-mcp/hosted-mcp/local-dev-setup.md)
    * [Multi-Site Deployments](ai/base-mcp/hosted-mcp/multi-site.md)    
    * [Customization](ai/base-mcp/hosted-mcp/customization.md)
    * [Architecture](ai/base-mcp/hosted-mcp/architecture.md)
    * [Security](ai/base-mcp/hosted-mcp/security.md)
    * [API Reference](ai/base-mcp/hosted-mcp/api-reference.md)
    * [Troubleshooting](ai/base-mcp/hosted-mcp/troubleshooting.md)
