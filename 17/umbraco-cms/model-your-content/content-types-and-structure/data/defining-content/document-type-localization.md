...
The Umbraco backoffice is localized to match the [user's configured UI Culture](../../../../develop-with-umbraco/tutorials/multilanguage-setup.md#changing-the-default-backoffice-language-of-a-user).
...
* Register the Document Type localization files via [a new manifest 'umbraco-package.json' file](../../../../extend-your-project/backoffice-extensions/extending-overview/extension-types/localization.md#registering-localization).
* Create the localizations in [user defined Document Type localization files](../../../../extend-your-project/backoffice-extensions/extending-overview/extension-types/localization.md#the-localization-file).
