...
For more information about creating custom dashboards, see the [Dashboards](../../../extend-your-project/backoffice-extensions/extending-overview/extension-types/dashboard.md) article.
...
For more information about Examine Management, see the [Examine Management](../../../develop-with-umbraco/application-code/examine/examine-management.md) article.
...
For more information about Models Builder, see the [Models Builder](../../../develop-with-umbraco/templating-and-rendering/templating/modelsbuilder/) article.
...
For more information about Health Checks, see the [Health Check](../../../run-in-production/infrastructure-and-ops/health-check/) articles.
