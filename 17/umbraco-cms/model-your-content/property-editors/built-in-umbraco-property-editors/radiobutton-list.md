...
![Radiobutton List Data Type Definition](../../../.gitbook/assets/RadioButton-List-DataType.png)

{% hint style="info" %}
You can use dictionary items to translate the values of a Radiobutton List property editor in a multilingual setup. For more details, see the [Creating a Multilingual Site](../../../develop-with-umbraco/tutorials/multilanguage-setup.md#translating-multi-value-property-editors) article.
{% endhint %}

## Content Example

![Radiobutton List Content](../../../.gitbook/assets/RadioButton-List-Content-v8.png)
