...
You can learn how to do this [Vite Package Setup](../../../../extend-your-project/backoffice-extensions/development-flow/vite-package-setup.md) article.
{% endhint %}
...
Once you have the above code in place, it can be referenced using a [bundle extension type](../../../../extend-your-project/backoffice-extensions/extending-overview/extension-types/bundle.md).
