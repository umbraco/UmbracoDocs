...
{% hint style="info" %}
These endpoints are infrastructure-level HTTP probes used by orchestrators and load balancers. They are different from the [Health Check dashboard](../health-check/) in the backoffice, which validates Umbraco and website-specific best practices.
{% endhint %}
