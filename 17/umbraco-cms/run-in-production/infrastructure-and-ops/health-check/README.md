---
description: >-
  Health Checks are used to determine the state of your Umbraco project. Learn
  more about each of them in this section.
---

# Health Check

{% hint style="info" %}
Looking for the .NET health probe endpoints used by orchestrators and load balancers? See [Health Probes](../server-setup/health-probes.md).
{% endhint %}
...
For inspiration when building your checks you can look at the checks we've [built into Umbraco](https://github.com/umbraco/Umbraco-CMS/tree/v17/dev/src/Umbraco.Core/HealthChecks/Checks), as well as our [guides](guides/). Some examples will follow in this document.
...
* Category **Security**
  ...
  * **Imaging Hash-based Message Authentication Code (HMAC) Secret Key** - verifies the presence of a configured imaging [HMAC secret key](../../../develop-with-umbraco/configuration/imagingsettings.md). The setting can be found under `Umbraco:CMS:Imaging:HMACSecretKey` in the `appsettings.json` file
* Category **Services**
...
For more information, see the [Reference > Configuration > Health checks](../../../develop-with-umbraco/configuration/healthchecks.md) article.
