...
### [UI Localization](../../backoffice-extensions/foundation/localization.md)
...
{% hint style="info" %}
You can use localization files for Document and Media Types as well. You can find more information about this in the [Document Type Localization](../../../model-your-content/content-types-and-structure/data/defining-content/document-type-localization.md) article.
{% endhint %}
