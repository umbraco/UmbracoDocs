...
Learn more about invoking and registering extension methods in the [Dependency Injection](../../../develop-with-umbraco/application-code/backend-and-custom-logic/using-ioc.md) article.
