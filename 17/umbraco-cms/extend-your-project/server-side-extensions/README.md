---
description: Extend Umbraco's server-side functionality using .NET APIs, custom routing, notifications, services, caching, and more.
---
...
<table data-view="cards"><thead><tr><th></th><th></th><th data-hidden data-card-target data-type="content-ref"></th></tr></thead><tbody><tr><td><strong>Cache & Distributed Cache</strong></td><td>Implement application caching in single-server and load-balanced environments.</td><td><a href="cache/">cache</a></td></tr><tr><td><strong>Custom Routing</strong></td><td>Configure custom routes and URL handling in Umbraco CMS.</td><td><a href="custom-routing/">custom-routing</a></td></tr><tr><td><strong>Language Files & Localization</strong></td><td>Manage localization and language files for your Umbraco site.</td><td><a href="language-files/">language-files</a></td></tr><tr><td><strong>Management</strong></td><td>Interact with Umbraco data through CRUD operations and the persistence layer.</td><td><a href="management/">management</a></td></tr><tr><td><strong>Using Notifications</strong></td><td>Subscribe to and handle Umbraco notifications to react to content and application events.</td><td><a href="notifications/">notifications</a></td></tr><tr><td><strong>Services and Helpers</strong></td><td>Access Umbraco data and functionality through the core services and helpers.</td><td><a href="services/">services</a></td></tr></tbody></table>
...
* [Custom File Systems](filesystemproviders/) - create custom file systems using the IFileSystem interface.
