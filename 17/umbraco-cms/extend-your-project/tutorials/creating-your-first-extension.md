...
Before following this tutorial, make sure to read the [Setup Your Development Environment](../backoffice-extensions/development-flow/) article.
...
{% hint style="info" %}
If you want to learn more about Vite, you can read the [Vite Package Setup](../backoffice-extensions/development-flow/vite-package-setup.md) article. It will go into more detail about the setup and how to use Vite with Umbraco. For this tutorial, we will assume you have read the article and have Vite installed.
{% endhint %}
...
{% hint style="warning" %}
If you see any errors during this process, make sure that you have the right tools installed (Node, .NET, and so on). Also, make sure you have followed the steps on how to [Setup Your Development Environment](../backoffice-extensions/development-flow/).
{% endhint %}
...
You can also read more about the [Umbraco Package Manifest](../backoffice-extensions/umbraco-package.md) to learn more about the different options you have when creating an extension.
