...
For more information on the block configuration, see the [Setup Block Types](../../model-your-content/property-editors/built-in-umbraco-property-editors/block-editor/block-list-editor.md#setup-block-types) section.
...
* `block-list` - For more information, see the [Block List editor](../../model-your-content/property-editors/built-in-umbraco-property-editors/block-editor/block-list-editor.md).
* `block-grid` - For more information, see the [Block Grid editor](../../model-your-content/property-editors/built-in-umbraco-property-editors/block-editor/block-grid-editor.md).
* `block-rte` - Blocks used inline in the [Rich Text editor](../../model-your-content/property-editors/built-in-umbraco-property-editors/rich-text-editor/blocks.md).
...
To render the stored value of your Block List editor on the frontend, see the [Rendering Block List Content](../../model-your-content/property-editors/built-in-umbraco-property-editors/block-editor/#block-list) section.
