...
You can find more information about menus and menu items in the [menu documentation](../backoffice-extensions/extending-overview/extension-types/menu.md).

## Conditions

The Help Menu Item is visible to all users by default. If you want to restrict the visibility of the menu item to specific users or based on certain conditions, you can use the [condition system](../backoffice-extensions/extending-overview/extension-types/condition.md).
