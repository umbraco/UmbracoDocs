...
Make sure you have followed the [requirements](../../../get-started/installation/requirements.md) article, especially having installed the following on your machine:
