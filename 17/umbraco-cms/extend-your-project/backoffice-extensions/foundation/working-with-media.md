...
Remove the pattern with the `--umb-media-thumbnail-background` custom property when the thumbnail represents final content, such as a block in a grid. The property is available from Umbraco 17.6.
