---
description: >-
  A guide to creating a custom Value Summary in Umbraco. Use it to render a
...
Many [repositories](../../foundation/repositories/) already return an `asObservable` alongside the data. Pass it through from your fetch call:
...
[property-editor-value-summary.md](../../property-editors/property-editor-value-summary.md)
{% endcontent-ref %}

Value Summary can also be used in a Table Collection View:

{% content-ref url="collections/collection-view/" %}
[collection-view](collections/collection-view/)
{% endcontent-ref %}
