---
description: >-
  Create menus that appear throughout the backoffice, including in sidebars and
  button flyouts.
---
...
Extension authors define the menu manifest, then register it dynamically/during runtime using a [Backoffice Entry Point](backoffice-entry-point.md) extension.
