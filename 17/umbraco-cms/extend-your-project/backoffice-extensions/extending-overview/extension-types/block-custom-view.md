---
description: >-
  Create a custom Web Component to visually represent blocks in Umbraco's Block
  editors.
---
...
{% hint style="info" %}
Before creating a Block Custom View, make sure you are familiar with the [Extension Registry in Umbraco](../extension-registry/register-extensions.md). You can also refer to the tutorial [Custom Views for Block List](../../../tutorials/creating-custom-views-for-blocklist.md) for a step-by-step guide.
{% endhint %}
