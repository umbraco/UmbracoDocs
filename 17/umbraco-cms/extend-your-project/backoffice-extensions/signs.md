...
Using this binding allows the server to determine which signs are present in the response via the registered collection of [Flag Providers](../server-side-extensions/flag-providers.md).
