...
If your custom field type requires a different presentation in the backoffice, you can register client-side components for it. For more information, see the [Adding A Field Type To Umbraco Forms](../adding-a-fieldtype/) article.
