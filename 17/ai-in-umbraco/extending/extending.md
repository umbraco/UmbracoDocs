...
{% content-ref url="providers/" %}
[providers](providers/)
{% endcontent-ref %}

{% content-ref url="middleware/" %}
...
[workflows.md](../add-ons/agent/workflows.md)
{% endcontent-ref %}

{% content-ref url="knowledge-sets.md" %}
[knowledge-sets.md](knowledge-sets.md)
{% endcontent-ref %}
