...
When installing Umbraco Engage, one customer journey is added based on the Google customer journey with the steps **See, Think, Do and Care**.
...
## Advanced customer journey group parameters

If you want to tweak the working of the customer journey scoring in-depth, you can go to the **Advanced** settings of a customer journey group.

These settings are shared between customer journey groups and persona groups. See [Persona and customer journey group settings](persona-and-customer-journey-group-settings.md) for details on each setting and how to fine-tune them.
