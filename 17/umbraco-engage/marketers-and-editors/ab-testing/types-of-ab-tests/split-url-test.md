...
You can start a Split URL test from the [Engage section](../../introduction/the-umbraco-engage-section.md) or within the [Workspace View](../../introduction/workspace-views.md). The type is selected in the **Test setup** section.
