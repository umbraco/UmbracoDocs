...
* See [Infrastructure Sizing](../getting-started/for-developers/infrastructure-sizing.md) for detailed Azure SQL recommendations

{% hint style="warning" %}
If you attempt to install Umbraco Engage on an Azure SQL tier lower than S3, the initial migration will fail. See [Troubleshooting Installations](../getting-started/for-developers/troubleshooting-installations.md) for workarounds.
{% endhint %}
...
See the [Troubleshooting](troubleshooting-installs.md) section if you need to upgrade from SQL CE to SQL Server.
