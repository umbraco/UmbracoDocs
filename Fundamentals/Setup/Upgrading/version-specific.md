...
:::warning
**Important**: .net version 6.0.5 is the minimum required version for Umbraco 10 to be able to run. You can check with `dotnet --list-sdks` what your latest SDK version is. SDK version 6.0.300 is the one that includes .net 6.0.5. At the time of writing, .net 6.0.6 is out with an SDK version of 6.0.301. 
:::
