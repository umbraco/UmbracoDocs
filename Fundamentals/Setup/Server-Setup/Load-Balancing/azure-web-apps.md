...
* The app service plan with the (Administrative) web app should never be scaled out but only up, as the web app needs to stay as a single instance.
* The app service plan with the (Public) web app can be scaled both out and up and having multiple instanced of it is the exact conctept of load balancing.
