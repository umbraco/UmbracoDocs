...
a response to a backoffice event, eg a content item being published that has picked several other content items - you might add a relationship between these items, to make querying between them easier. 
