...
Offline approval does require a user to exist in the backoffice and be assigned to a workflow group - like any other workflow participant - but they need not know how to use Umbraco, or even know their login credentials.
