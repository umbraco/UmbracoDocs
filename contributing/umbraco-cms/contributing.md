...
- [Before you start](contributing-before-you-start)
- [Finding your first issue: Up for grabs](contributing-before-you-start)
- [Unwanted changes](contributing-unwanted-changes)
- [Other ways to contribute](contributing-other-ways-to-contribute)
