...
If you're unsure about whether your changes belong in the core Umbraco CMS or if you should turn your idea into a package instead, make sure to [talk to us](before-you-start.md#making-larger-changes).
...
When your contribution has been accepted, it will be [MIT licensed](../../LICENSE.md) from that time onwards.
