...
![Screenshot that shows the Sponsor heart option](../.gitbook/assets/hacktoberfest_screenshot.png)
...
![Screenshot that shows the Discord #contributing channel](../.gitbook/assets/discord_contributing.png)
