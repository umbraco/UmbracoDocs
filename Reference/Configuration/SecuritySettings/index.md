...
When the setting is set to `false` the invariant properties that are shared between all languages can be edited by all no matter what language you have permission to manage.
