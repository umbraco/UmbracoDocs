...
**WARNING**: **Thinking about writing your own model classes or extending those generated by the ModelsBuilder? Make sure you read the *[Content Factory & Content Cache](#content-factory-content-cache)* section below, in order to fully understand what to do, and not to do.**
...
When you install the ModelsBuilder, the default factory is automatically enabled. If you do not want to use the ModelsBuilder and yet you want to use the default factory (with your own model classes), you will need to explicitly enable it.
