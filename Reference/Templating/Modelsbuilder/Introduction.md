...
And once you are using strongly typed models, there are some [cool things](CoolThingsWithModels-v9.md) that you can do.
...
Models Builder is one way to generate models for the default, built-in factory. Models can be generated automatically or straight from the Settings section of the Umbraco backoffice, for more info see [builder modes](Builder-Modes-v9.md). 