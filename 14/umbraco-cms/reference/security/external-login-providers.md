...
{% hint style="info" %}
You have access to the [Umbraco UI Library](../../customize-the-backoffice/ui-library.md) in the custom element. You can use the UUI components directly in your template.
{% endhint %}
