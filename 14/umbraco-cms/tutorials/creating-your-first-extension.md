...
You can also read more about the [Umbraco Package Manifest](../customize-the-backoffice/umbraco-package.md) to learn more about the different options you have when creating an extension.
