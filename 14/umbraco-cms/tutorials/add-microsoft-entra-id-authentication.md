...
{% hint style="warning" %}
Microsoft Entra ID (formerly Azure Active Directory) conflicts with Umbraco ID when used for backoffice user logins on Umbraco Cloud projects. This does not affect member logins.
