...
This can lead to a situation where Deploy continues to process a file it considers as changed, even though the item represented is up-to-date. Which in turn means slow updates of Umbraco schema, as Deploy is processing more files than it needs to do.
