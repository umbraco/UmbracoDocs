...
See [Content Version Cleanup](../../../02-Grundlagen/Data/Content-Version-Cleanup/index.md) for more details on overriding configuration and preventing cleanup of specific versions.
