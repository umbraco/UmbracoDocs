---
description: >-
  Configuring virtual sub trees in Umbraco UI Builder, the backoffice UI builder
  for Umbraco.
---
...
![Example virtual sub tree injected into a Vendr store tree](../.gitbook/assets/virtual-sub-tree.png)

## Defining virtual SubTrees

You define a virtual subtree by calling one of the `AddVirtualSubTree` methods of a [`WithTreeConfigBuilder`](../areas/trees/#extending-an-existing-tree) instance.
