---
description: >-
  Configuring dashboards in Umbraco UI Builder, the backoffice UI builder for
  Umbraco.
---
...
![Dashboards](../.gitbook/assets/dashboards.png)

## Defining a dashboard

You can define a dashboard by calling one of the `AddDashboard` methods on either a [`SectionConfigBuilder`](sections/) or a [`WithSectionConfigBuilder`](sections/#extending-an-existing-section) instance.
