---
description: >-
  Configuring sections in Umbraco UI Builder, the backoffice UI builder for
  Umbraco.
---
...
Accesses the tree config of the current section. For more information check the [Trees documentation](../trees/).
...
Adds a tree to the current section. For more information check the [Trees documentation](../trees/).
...
Adds a tree to the current section in a group with the given name. For more information check the [Trees documentation](../trees/).
...
Adds a tree to the current section **before** the tree with the given alias. For more information check the [Trees documentation](../trees/).
...
Adds a tree to the current section **after** the tree with the given alias. For more information check the [Trees documentation](../trees/).
