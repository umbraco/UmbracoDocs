...
[Browse the API documentation for IMemberTypeService interface](https://apidocs.umbraco.com/v11/csharp/api/Umbraco.Cms.Core.Services.IMemberTypeService.html).
