---
description: This article will give you the basics of working with configurations in Umbraco CMS, as well as an overview of the available settings.
---

# Configuration

Configuration in Umbraco is now done using `IConfiguration` with diffent sources, like the `appsettings.json` file located at root.
...
It is not feasible to have an entire json file as an environment variable, and the `:` doesn't work with environment variables on all platforms. Instead a double underscore is used to create the hierachy.
...
* [Member Password Configuration Setting](memberpasswordconfigurationsettings.md)
...
* [User Password Configuration Setting](userpasswordconfigurationsettings.md)
