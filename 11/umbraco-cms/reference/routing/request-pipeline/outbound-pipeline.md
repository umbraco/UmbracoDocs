...
To explain things we will use the following content tree: ![content tree](../../../../../10/umbraco-cms/reference/routing/request-pipeline/images/simple-content-tree-v8.png)
...
![path example](../../../../../10/umbraco-cms/reference/routing/request-pipeline/images/path-example-v8.png)
...
![Culture and Hostnames multiple domains](../../../../../10/umbraco-cms/reference/routing/request-pipeline/images/culture-and-hostnames-v8.png)

What the editor sees without any SiteDomainMapper, visiting the backoffice url:

![All domains listed](../../../../../10/umbraco-cms/reference/routing/request-pipeline/images/no-sitedomainhelp.png)
...
![Staging domain only](../../../../../10/umbraco-cms/reference/routing/request-pipeline/images/staging-only-staging.png)
...
![Backoffice + production domains only](../../../../../10/umbraco-cms/reference/routing/request-pipeline/images/backoffice-see-prod.png)
