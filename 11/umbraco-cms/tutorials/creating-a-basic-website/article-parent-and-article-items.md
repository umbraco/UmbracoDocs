...
5.  Let's add two fields with the following specifications:
    ...
    ![Articles Main Document Type Data Properties](../../../../10/umbraco-cms/tutorials/creating-a-basic-website/images/figure-38-articles-main-v8.png)
6. Click **Save**
...
5.  Let's add two fields with the following specifications:
    ...
    ![Article Item Document Type Data Properties](../../../../10/umbraco-cms/tutorials/creating-a-basic-website/images/figure-39-articles-item-v8.png)
6. Click **Save**
