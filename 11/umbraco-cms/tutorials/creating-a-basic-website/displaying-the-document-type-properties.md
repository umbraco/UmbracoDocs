...
3.  Scroll down to the `<!-- Jumbotron, w title -->` section (around line 46) and highlight the text `“Welcome - UmbracoTV”` (around line 49).
    ...
    <figure><img src="../../.gitbook/assets/figure-18-replace-hardcoded-text-with-umbraco-page-field-v9.png" alt=""><figcaption><p>Replace Page Title Value</p></figcaption></figure>
