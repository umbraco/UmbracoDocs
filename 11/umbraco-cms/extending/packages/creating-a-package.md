...
3.  Select the `Create package` button.
    ...
    ![Buttons to select for creating a package schema in the backoffice](../../.gitbook/assets/creating-package-menu-v9.png)
...
![Content of a ZIP package](../../.gitbook/assets/zip-package-v9.png)
...
![Content of an empty package](../../.gitbook/assets/empty-package-from-template.png)
...
![App\_Plugins with dashboard files](../../.gitbook/assets/app-pligins-contents.png)
...
![Package properties](../../.gitbook/assets/package-properties.png)
