...
Follow the [steps outlined in the Umbraco Cloud documentation](https://docs.umbraco.com/umbraco-cloud/upgrades/migrate-from-umbraco-7-to-8.md) to upgrade your Umbraco 7 site on Cloud.
{% endhint %}
...
![Upgrading to v7.14](../images/upgrading-7\_14.png)
...
![Fresh 8.1 site](../images/fresh-8\_1-site.png)
...
![Upgrade database to 8.1](../../../../../../umbraco-cloud/upgrades/images/upgrade-to-8\_1.png)

From here, the automatic migration will take over, and after a little bit you can log in and see your content:

![Content is on 8.1](../images/content-on-8\_1.png)
