...
![v7 site with content](<../../../../../../10/umbraco-cms/fundamentals/setup/upgrading/version-specific/images/v7-content (1).png>)

Following the [general upgrade instructions](../) we will now upgrade via Nuget until we get to this point:

![Upgrading to v7.14](<../../../../../../10/umbraco-cms/fundamentals/setup/upgrading/version-specific/images/upgrading-7\_14 (2).png>)
...
![Fresh 8.1 site](<../../../../../../10/umbraco-cms/fundamentals/setup/upgrading/version-specific/images/fresh-8\_1-site (2).png>)
...
![Set Umbraco version in the web.config](<../../../../../../10/umbraco-cms/fundamentals/setup/upgrading/version-specific/images/set-umbraco-version (1).png>)
...
![Upgrade database to 8.1](<../../../../../../10/umbraco-cms/fundamentals/setup/upgrading/version-specific/images/upgrade-to-8\_1 (1).png>)

From here, the automatic migration will take over, and after a little bit you can log in and see your content:

![Content is on 8.1](../../../../../../10/umbraco-cms/fundamentals/setup/upgrading/version-specific/images/content-on-8\_1.png)
