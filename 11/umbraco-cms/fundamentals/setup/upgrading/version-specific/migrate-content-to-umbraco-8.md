...
![v7 site with content](<../../../../../../10/umbraco-cms/fundamentals/setup/upgrading/images/v7-content (1) (1) (1).png>)

Following the [general upgrade instructions](../) we will now upgrade via Nuget until we get to this point:

![Upgrading to v7.14](<../../../../../../10/umbraco-cms/fundamentals/setup/upgrading/images/upgrading-7\_14 (1) (1) (1).png>)
...
![Fresh 8.1 site](<../../../../../../10/umbraco-cms/fundamentals/setup/upgrading/images/fresh-8\_1-site (1) (1) (1).png>)
...
![Set Umbraco version in the web.config](<../../../../../../10/umbraco-cms/fundamentals/setup/upgrading/images/set-umbraco-version (1) (1) (2).png>)
...
![Upgrade database to 8.1](<../../../../../../10/umbraco-cms/fundamentals/setup/upgrading/images/upgrade-to-8\_1 (1) (1).png>)

From here, the automatic migration will take over, and after a little bit you can log in and see your content:

![Content is on 8.1](<../../../../../../10/umbraco-cms/fundamentals/setup/upgrading/images/content-on-8\_1 (1) (1) (1).png>)
