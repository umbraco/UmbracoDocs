...
![v7 site with content](<../images/v7-content (1) (1) (3).png>)

Following the [general upgrade instructions](../) we will now upgrade via Nuget until we get to this point:

![Upgrading to v7.14](<../images/upgrading-7\_14 (1) (1) (3).png>)
...
![Fresh 8.1 site](<../images/fresh-8\_1-site (1) (1) (3).png>)
...
![Set Umbraco version in the web.config](<../images/set-umbraco-version (1) (1) (3).png>)
...
![Upgrade database to 8.1](<../../../../../../umbraco-cloud/product-upgrades/images/upgrade-to-8\_1 (2) (1).png>)

From here, the automatic migration will take over, and after a little bit you can log in and see your content:

![Content is on 8.1](<../images/content-on-8\_1 (1) (1) (3).png>)
