...
![File conflict dialog with a web.config file in conflict](<../images/nuget-overwrite-dialog (1).png>) ![File conflict console message with multiple files in conflict](../images/nuget-upgrade-overwrite.png)
