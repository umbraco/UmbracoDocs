...
Although the Forms package comes with many fields, workflows and other built-in types, if you have a requirement that isn't served by any of these, you can create and develop your own.
