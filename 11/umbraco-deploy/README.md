...
Umbraco Deploy is also the engine that runs behind the scenes on [Umbraco Cloud](../umbraco-cms/extending/content-apps.md). Here it takes care of all the deployment processes of both code, schema and content on projects.
