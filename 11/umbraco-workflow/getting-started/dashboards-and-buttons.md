...
*   **User Dashboard** - This Workflow Dashboard is added in the **Content** section. It displays the tasks requiring approval from the user, current user’s submissions, and stale content (content that needs to be reviewed).
    ...
    ![Workflow Dashboard in the Content Section](../../../10/umbraco-workflow/getting-started/images/WorkflowDashboard-ContentSection.png)
...
![Buttons drawe](../../../10/umbraco-workflow/getting-started/images/Buttons.png)
...
![Disabled content edits](../../../10/umbraco-workflow/getting-started/images/blocked-content.png)

For nodes where the workflow has been disabled, the default Umbraco options are displayed.

![Default Button](../../../10/umbraco-workflow/getting-started/images/Default-Buttons.png)
