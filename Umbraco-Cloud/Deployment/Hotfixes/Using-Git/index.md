...
When you are ready building on your Development environment, simply follow the [normal workflow of Cloud](../../index.md) to deploy the changes to the Live environment.
