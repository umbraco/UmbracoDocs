...
If your project has a lot of content nodes and/or media items you might not want to restore everything everytime a minor change has been made to the content.
...
4. From the *dropdown* you will be able to choose from which environment you want to restore the content node
