...
## Key Takeaways
- **Runtime settings for .NET versions** - We have made it real easy for you to change the .NET runtime for Umbraco 9 and Umbraco 10 cloud projects. You can change it on a per environment basis.
