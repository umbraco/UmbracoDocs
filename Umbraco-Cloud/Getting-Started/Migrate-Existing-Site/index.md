...
First order of business is to **upgrade your own Umbraco site to the latest minor version of Umbraco v.7 or v.8 **. Why? Because Umbraco Cloud always runs the latest version and you need to make sure your project runs the same Umbraco version as Umbraco Cloud.
