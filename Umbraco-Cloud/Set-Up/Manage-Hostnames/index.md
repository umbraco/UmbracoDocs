...
:::note
Please note that the Certificate Authority (CA) used to issue certificates for all Umbraco Cloud sites' custom hostnames will change in [the coming months](ca-record-migration.md).
:::
