...
## Prerequisites
In order for Latch to work and the certificate to be applied the root of the site that the domain is pointing to cannot have the status of 404 whether it's a custom 404 or one caused by an error.
