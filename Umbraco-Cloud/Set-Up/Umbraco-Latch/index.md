...
## Prerequisites
In order for Latch to work and the TLS certificate to be applied to the site, you need to fullfill some criteria. First of all, the content node that the domain is pointing to cannot have the status of 404 whether it's a custom 404 page or one caused by an error.
