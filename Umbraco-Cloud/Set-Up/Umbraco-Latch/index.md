...
In that case you can manually add a TLS certificate to your project instead. Read more about how to do that in the [Upload certificates manually](https://our.umbraco.com/Documentation/Umbraco-Cloud/Set-Up/Manage-Hostnames/Security-Certificates/) article.
