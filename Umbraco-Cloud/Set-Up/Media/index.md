...
Since Umbraco includes a version of ImageProcessor.Web and ImageProcessor.Web.Config by default, you will need to update those packages first using NuGet:
