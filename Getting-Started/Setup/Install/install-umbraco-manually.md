...
While giving broad permissions is usually fine for development environments, you may want to restrict permissions further on a public-facing server. See [permissions](/Documentation/Getting-Started/Setup/Server-Setup/permissions.md) for more details.
