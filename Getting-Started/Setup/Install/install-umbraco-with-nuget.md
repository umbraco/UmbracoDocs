...
##Abbreviated version
- You will get the best results if you install Umbraco in a **blank** web application Visual Studio project using .net versions equal/higher than 4.5.2 and lower than 5.0.0.
...
If you're installing Umbraco 7+ then you need to choose .NET Framework 4.5.2 here.  
For Umbraco 6 you can still choose .NET Framework 4, but 4.5 and 4.5.1 also work. Versions older than 4.5.2 are [now end of life](http://blogs.msdn.com/b/dotnet/archive/2014/08/07/moving-to-the-net-framework-4-5-2.aspx).
