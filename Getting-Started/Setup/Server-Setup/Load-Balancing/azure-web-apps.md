...
The single instance back office Web App should be set to use [file-system-replication.md#examine-directory-factory-options](SyncTempEnvDirectoryFactory).

The multi instance front end Web App should be set to use [file-system-replication.md#examine-directory-factory-options](TempEnvDirectoryFactory).
