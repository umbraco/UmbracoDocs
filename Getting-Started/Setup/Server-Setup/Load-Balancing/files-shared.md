...
The `umbracoLocalTempStorage` setting controls where the `umbraco.config` and the other Umbraco TEMP files are stored. You can read more about this setting at the page about [Web.config](../../../../Reference/Config/webconfig/index.md#umbracolocaltempstorage-umbraco-v773).
