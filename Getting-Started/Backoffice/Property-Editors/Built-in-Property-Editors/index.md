...
The markdown editor will be interpreted by the Modelsbuilder. Behind the scenes, Umbraco uses the [Markdown nuget package](https://www.nuget.org/packages/Markdown/).
