...
Other Angular filters
   - `{{ pickerAlias | ncNodeName }}` shows the name of content/media and member node(s) instead of the id(s).
   - `{{pickerAlias | ncRichtext}}` shows text content limited to one line and any html is removed.
