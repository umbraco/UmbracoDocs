...
This feature can be turned off completely using the `allowPasswordReset` configuration, see: [UbracoSettings - Security](/Reference/Config/umbracoSettings/index.md/#security) 
