...
This feature can be turned off completely using the `allowPasswordReset` configuration, see: [UbracoSettings - Security](/UmbracoDocs/Reference/Config/umbracoSettings/index.md/#security) 
