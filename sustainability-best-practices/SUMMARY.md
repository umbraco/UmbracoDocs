...
* [Performance Testing](backend/performance-testing.md)
* [Common pitfalls](backend/common-pitfalls.md)
* [SOAP, REST and GraphQL](backend/soap-rest-graphql.md)
* [SQL optimization](backend/sql-optimization.md)
* [JAMstack](backend/jamstack.md)
* [Monolithic vs. Service based Architecture](backend/monolithic-vs-service.md)
* [Async](backend/async.md)
...
* [Limit use of 3rd parties](frontend/limit-use-of-3rd-parties.md)
* [Lazyload resources](frontend/lazy-load-resources.md)
