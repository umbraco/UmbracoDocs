...
description: API reference for ExportTemplateService in Vendr, the eCommerce solution for Umbraco
---
...
```csharp
public ExportTemplateService(LicensingService licensingService, 
