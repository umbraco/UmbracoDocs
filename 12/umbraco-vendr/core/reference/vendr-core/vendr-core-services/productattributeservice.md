...
description: API reference for ProductAttributeService in Vendr, the eCommerce solution for Umbraco
---
...
```csharp
public ProductAttributeService(LicensingService licensingService, 
    IRepositoryFactory repositoryFactory, IUnitOfWorkProvider uowProvider, 
    ILogger<ProductAttributeService> logger, ICacheAccessor cacheAccessor)
```
