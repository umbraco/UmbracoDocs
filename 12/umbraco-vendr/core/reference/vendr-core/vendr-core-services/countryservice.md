...
description: API reference for CountryService in Vendr, the eCommerce solution for Umbraco
---
## CountryService
...
```csharp
public CountryService(LicensingService licensingService, IRepositoryFactory repositoryFactory, 
    IUnitOfWorkProvider uowProvider, ILogger<CountryService> logger, ICacheAccessor cacheAccessor)
```
