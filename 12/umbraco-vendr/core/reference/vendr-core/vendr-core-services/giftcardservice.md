...
description: API reference for GiftCardService in Vendr, the eCommerce solution for Umbraco
---
## GiftCardService
...
```csharp
public GiftCardService(LicensingService licensingService, IRepositoryFactory repositoryFactory, 
    IUnitOfWorkProvider uowProvider, ILogger<GiftCardService> logger, ICacheAccessor cacheAccessor, 
