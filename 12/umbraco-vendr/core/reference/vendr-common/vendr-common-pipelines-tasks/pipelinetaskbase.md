...
description: API reference for PipelineTaskBase in Vendr, the eCommerce solution for Umbraco
---
## PipelineTaskBase
...
* interface [IPipelineAction](../../vendr-common-pipelines/ipipelineaction/)
* interface [IPipelineTask](../../vendr-common-pipelines/ipipelinetask/)
