...
Once the NuGet package is installed, you need to register SQLite support with Umbraco Commerce via the [`IVendrBuilder`](../key-concepts/vendr-builder.md) interface.
