...
The user's IP address can be recorded when a form is submitted and stored in the `UFRecords` database table.

To enable this feature set this value to `true`.
