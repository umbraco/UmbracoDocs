...
The default value for this setting is `None` which means not tracking will be performed.

If set to `RemoteIpAddress`, the IP obtained from the request's connection property will be recorded.
