...
When upgrading Umbraco Commerce, be sure to also consult the [version specific upgrade](/10/umbraco-commerce/getting-started/installation/version-specific-upgrades.md) notes to learn about potential breaking changes and common pitfalls.
