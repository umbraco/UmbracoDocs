...
The Delivery API supports protected content and member authentication. This is however an opt-in feature (read more about it [here](./protected-content-in-the-delivery-api)).
