...
If you want to store the media files in a separate folder, outside of the webroot folder, maybe on a Network-attached storage/Storage Area Network (NAS/SAN), there's a few more steps.
