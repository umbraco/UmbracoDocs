...
The recommended API key value is a **Base64-encoded string of 64 randomly generated bytes**, resulting in a value of 88 characters. In order to maintain backward compatibility the minimum requirement is 10 characters.
