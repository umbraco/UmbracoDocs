...
The recommended API key value is a **Base64-encoded string of 64 randomly generated bytes** (which will result in a value of 88 characters), although to maintain backwards compatibility the minimum requirement is 10 characters.
