...
{% hint style="info" %}
This is the documentation for the upcoming **Umbraco 10.4** release. For information on the latest features, see the [Release Candidates Blog Post](https://umbraco.com/blog/umbraco-111-release-candidate/).

**New documentation in the RC:**

* [Maintenance Page](umbraco-cms/tutorials/custom-error-page.md#maintenance-page)
* [Block Grid Editor](umbraco-cms/fundamentals/backoffice/property-editors/built-in-umbraco-property-editors/block-editor/block-grid-editor.md)
{% endhint %}
