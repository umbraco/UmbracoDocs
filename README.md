...
With the introduction, every new version of Umbraco new features is introduced.  This means that not every document will work for your possibly older version.
