...
<div class="row">
    ...
    <div class="col-xs-9">
        <div class="row explain">
            ...
            <div class="col-sm-6">
                <h5><a href="Inbound-Pipeline/index.md">Inbound request pipeline</a></h5>
                <small>Matching a URL to a content item & determining the rendering engine (MVC or Webforms).</small>
            </div>
            <div class="col-sm-6">
                <h5><a href="Controller-Selection/index.md">Controller selection</a></h5>
...
<div class="row">
    ...
    <div class="col-xs-9">
        <div class="row explain">
            <div class="col-xs-12">
                <h4 class="text-right"><a href="Execute-Request/index.md">Execute request</a></h4>
