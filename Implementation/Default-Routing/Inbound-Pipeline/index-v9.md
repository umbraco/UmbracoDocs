...
The inbound process is triggered by `UmbracoRouteValueTransformer` and then handled with the Published router. The [Published Content Request Preparation](../../../Reference/Routing/Request-Pipeline/published-content-request-preparation-v9.md) process kicks in and creates a `PublishedRequestBuilder` which will be used to create a `PublishedContentRequest`.
...
- [Routing in Umbraco](../../../Reference/Routing/Request-Pipeline/index-v9.md)
