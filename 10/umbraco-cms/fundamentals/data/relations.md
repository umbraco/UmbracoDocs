...
![Parent, Siblings & Children](../../../../11/umbraco-cms/fundamentals/data/images/parent-siblings-children.png)
...
![Relation Types Tree](../../../../11/umbraco-cms/fundamentals/data/images/relation-types-tree.png)
...
![Default Relation Types](../../../../11/umbraco-cms/fundamentals/data/images/default-relation-types.png)
...
![Create Relation Type](../../../../11/umbraco-cms/fundamentals/data/images/create-relation-type.png)
...
5.  Choose the different types for each entity (**Parent** and **child**) from the drop-down list.
    ...
    ![Member Images](../../../../11/umbraco-cms/fundamentals/data/images/member-images.png)
...
7.  Click **Create** and you'll see your new Relation Type created in the Relation Types folder. You can see the 'Alias' that you'll need to make note of when working with Relations.
    ...
    ![Member Images](../../../../11/umbraco-cms/fundamentals/data/images/relation-alias.png)
...
![View Relations](../../../../11/umbraco-cms/fundamentals/data/images/view-relations.png)
