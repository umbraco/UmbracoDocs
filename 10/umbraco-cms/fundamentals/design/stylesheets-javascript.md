...
![Creating a new stylesheet](../../../../11/umbraco-cms/fundamentals/design/images/1-creating-stylesheet.png)
...
![Stylesheet Rich Text Editor (RTE)](../../../../11/umbraco-cms/fundamentals/design/images/2-rte-editor.png)

The rules you create in the Rich Text Editor section will carry over to the Code tab.

![Stylesheet RTE tab](../../../../11/umbraco-cms/fundamentals/design/images/3-rte-editor-p2.png) ![Stylesheet Code tab](../../../../11/umbraco-cms/fundamentals/design/images/3-rte-editor-p3.png)
...
![Linking CSS in template](../../../../11/umbraco-cms/fundamentals/design/images/4-link-css-v9.png)
...
![Creating a new JavaScript](../../../../11/umbraco-cms/fundamentals/design/images/8-create-js.png)

From here you can add a new JavaScript file, or a new folder.

Add a new JavaScript file and write your code:

![Sample JS script](../../../../11/umbraco-cms/fundamentals/design/images/9-myscript.png)
...
![Reference the script in template](../../../../11/umbraco-cms/fundamentals/design/images/10-reference-script-v9.png)
