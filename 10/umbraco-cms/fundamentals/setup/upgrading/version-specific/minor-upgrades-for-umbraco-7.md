...
![File conflict dialog with a web.config file in conflict](<../../../../../../11/umbraco-cms/fundamentals/setup/upgrading/images/nuget-overwrite-dialog (1) (1) (1).png>) ![File conflict console message with multiple files in conflict](<../../../../../../11/umbraco-cms/fundamentals/setup/upgrading/images/nuget-upgrade-overwrite (1) (1) (1).png>)
