...
{% hint style="info" %}
You can find the database connection string under Umbraco:CMS:ConnectionStrings section in the `appsettings.json` file. For more information, see the [Connection strings settings](../reference/configuration/connectionstringssettings.md) article.
{% endhint %}
