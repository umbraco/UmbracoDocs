...
* Category **Security**
  ...
  * **Content/MIME Sniffing Protection (id: `1CF27DB3-EFC0-41D7-A1BB-EA912064E071`)** - checks that your site contains a header used to protect against MIME (Multipurpose Internet Mail Extensions) sniffing vulnerabilities
...
* Category **Services**
  * **SMTP Settings (id: `1B5D221B-CE99-4193-97CB-5F3261EC73DF`)** - checks that an SMTP (Simple Mail Tranfer Protocol) server is configured and is accepting requests for sending emails
...
If you want to get the notifications by email, SMTP (Simple Mail Transport Protocol) settings should also be configured in the same JSON file.
