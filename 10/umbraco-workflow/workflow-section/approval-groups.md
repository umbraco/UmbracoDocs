...
![Approval groups](../../../11/umbraco-workflow/images/Approval-groups.png)
...
9.  Click **Save Group**.
    ...
    <figure><img src="../../../11/umbraco-workflow/images/Create-approval-group.png" alt="Create Approval Group"><figcaption><p>Create Approval Groups</p></figcaption></figure>
...
![Approval group Settings](../../../11/umbraco-workflow/images/Approval-group-settings.png)
...
![Approval group Roles](../../../11/umbraco-workflow/images/approval-groups-role.png)
...
![Approval group Members](../../../11/umbraco-workflow/images/approval-group-members.png)
...
6.  Select the **Users** you want to add to the approval group.
    ...
    ![Add group Members](../../../11/umbraco-workflow/images/add-group-member.png)
7. Click **Save Group**.
...
6.  Select the **User groups** you want to add to the approval group.
    ...
    ![Inherited group membership](../../../11/umbraco-workflow/images/Inherited-group-membership.png)
7. Click **Save Group**.
...
![Approval group history](../../../11/umbraco-workflow/images/approval-group-history.png)
...
![Details overlay](../../../11/umbraco-workflow/images/details-overlay.png)
