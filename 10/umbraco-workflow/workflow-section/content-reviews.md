...
![Enable Content Reviews](../../../11/umbraco-workflow/images/Enable-content-reviews.png)
...
![Content Reviews Dashboard](../../../11/umbraco-workflow/images/Content-review-dashboard.png)
...
![Content Review Message Banner](../../../11/umbraco-workflow/images/content-review-message-banner.png)
...
![Content Review Date](../../../11/umbraco-workflow/images/content-review-date.png)
...
![Content Reviews Filters](../../../11/umbraco-workflow/images/content-reviews-filter.png)

Additionally, you can adjust the total number of records displayed on a page.

![Content Reviews PageSize](../../../11/umbraco-workflow/images/content-reviews-pagesize.png)
...
![General settings](../../../11/umbraco-workflow/images/content-reviews-general-settings.png)
...
![Content review permissions](../../../11/umbraco-workflow/images/Content-review-permissions.png)

The current permissions for a content node are displayed in the **Workflow** content app on the **Configuration** tab.

![Workflow Content App - Configuration tab](../../../11/umbraco-workflow/images/workflow-content-app-configuration.png)
...
3.  Click **Add** in the **Content item reviews** section.
    ...
    <figure><img src="../../../11/umbraco-workflow/images/content-item-reviews.png" alt=""><figcaption><p>Content Item Reviews</p></figcaption></figure>
4.  Select **Content node** to add to the Content item reviews section.

    <figure><img src="../../../11/umbraco-workflow/images/content-item-reviews-select-content.png" alt=""><figcaption><p>Select Content Node</p></figcaption></figure>
...
10. Click Submit.
    ...
    <figure><img src="../../../11/umbraco-workflow/images/content-item-reviews-settings.png" alt=""><figcaption><p>Edit Content Item Review Settings</p></figcaption></figure>
11. Click Submit.
...
3.  Click **Add** in the **Document-type reviews** section.
    ...
    <figure><img src="../../../11/umbraco-workflow/images/document-type-reviews.png" alt=""><figcaption><p>Document Type reviews</p></figcaption></figure>
4.  Select **Content type** to add to the Document-type reviews section.

    <figure><img src="../../../11/umbraco-workflow/images/document-type-reviews-select-content.png" alt=""><figcaption><p>Select Content Type</p></figcaption></figure>
...
10. Click Submit.
    ...
    <figure><img src="../../../11/umbraco-workflow/images/document-type-review-settings.png" alt=""><figcaption><p>Add Document Type Review Settings</p></figcaption></figure>
11. Click Submit.
12. Click **Save Settings**.
