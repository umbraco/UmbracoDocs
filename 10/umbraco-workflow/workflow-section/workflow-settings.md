...
![Workflow settings](<../images/workflow-settings (1).png>)
...
![General settings](<../images/general-settings (1).png>)
...
3.  Click **Add** in the **New node approval flow** section.
    ...
    <figure><img src="../images/new-node-approval-flow (1).png" alt=""><figcaption><p>New Node Approval Flow</p></figcaption></figure>
4.  Select an **approval group** to add to the workflow.

    <figure><img src="../images/add-approval-flow (1).png" alt=""><figcaption><p>Add Workflow Approval Groups</p></figcaption></figure>
5. Click **Submit**.
...
3.  Click **Add** in the **Document type approval flows** section.
    ...
    <figure><img src="../images/doc-type-approval-flows (1).png" alt=""><figcaption><p>Document Type Approval Flows</p></figcaption></figure>
4.  Select a **Document type** from the drop-down list.

    <figure><img src="../images/add-doc-type-approval-flows (1).png" alt=""><figcaption><p>Add Document Type Approval Flows</p></figcaption></figure>
...
7.  Click **Add condition** to add a condition to the workflow process.
    ...
    <figure><img src="../images/add-doc-type-approval-flows-settings (1).png" alt=""><figcaption><p>Configure Document Type Approval Flow Settings</p></figcaption></figure>
8. Click **Submit**.
...
3.  Click **Edit** next to the content node in the **Document type approval flows** section.
    ...
    <figure><img src="../images/edit-doc-type-approval-flows (1).png" alt=""><figcaption><p>Edit Document Type Approval Flow</p></figcaption></figure>
...
6.  Click **Add condition** to add a condition to the workflow process.
    ...
    <figure><img src="../images/edit-doc-type-approval-flows-settings (1).png" alt=""><figcaption><p>Configure Document Type Approval Flow</p></figcaption></figure>
7. Click **Submit**.
...
3.  Click **Add** in the **Exclude nodes** section.
    ...
    <figure><img src="../images/exclude-nodes (1).png" alt=""><figcaption><p>Exclude Nodes</p></figcaption></figure>
4.  Select the **Content node** from the Content tree.

    <figure><img src="../images/select-content-from-tree (1).png" alt=""><figcaption><p>Select Content Node</p></figcaption></figure>
5. Click **Submit**.
6. Click **Save Settings**.
