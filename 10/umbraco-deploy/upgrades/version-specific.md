...
{% hint style="info" %}
If you are upgrading to a new minor version you can find the details about the changes in the [release notes](/10/umbraco-deploy/release-notes.md) article
{% endhint %}
