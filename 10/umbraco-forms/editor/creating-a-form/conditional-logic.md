...
2.  Select **Enable Conditions** in the **Conditions** section.
    ...
    <figure><img src="images/EnableConditions-v9 (1).png" alt=""><figcaption></figcaption></figure>
3.  Enabling the condition field displays more options:

    <figure><img src="images/conditions-v9 (1).png" alt=""><figcaption></figcaption></figure>
...
![Setup rule](<images/conditions-v9 (1).png>)
...
![See conditions in the Forms designer](<images/exampleBackoffice-v9 (1).png>)

## Result

When both the conditions have been set as shown above, this is how it will look on the frontend:

![Frontend Example](<images/exampleFrontend-v9 (1).png>)
