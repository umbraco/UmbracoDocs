...
In many cases, you might prefer rendering your scripts at the bottom of the page, for example before the closing `</body>` tag, as this generally improves site performance.
