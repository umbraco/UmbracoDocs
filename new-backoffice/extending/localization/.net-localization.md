...
As Umbraco is a continually evolving product it is inevitable that new text is added on a regular basis to the English language version of these files. This may mean that some of the above languages are no longer up to date.
