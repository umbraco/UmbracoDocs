...
![The interface when signing up for a Klarna live account.](../.gitbook/assets/get_started.png)
...
![The interface when signing up for a Klarna developer account.](../.gitbook/assets/developer_signup_1.png)
...
![The Klarna Login screen](../.gitbook/assets/sign_in.png)
...
![Overview of the Klarna developer portal.](../.gitbook/assets/developer_portal.png)
...
![The dialog where you create your Klarna API credentials.](../.gitbook/assets/generate_credentials.png)

![The dialog that presents your Klarna credentials.](../.gitbook/assets/credentials.png)
...
![Overview of Klarna orders.](../.gitbook/assets/orders.png)

![Overview over how an order looks like in the Klarna portal.](../.gitbook/assets/order.png)
