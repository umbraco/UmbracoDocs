...
7. Add and commit the changes through Git.
   * Learn more about working with a local Cloud clone in the [Deploying Changes](broken-reference) article.
...
### [Deploy the migration to the Live environment](broken-reference)
