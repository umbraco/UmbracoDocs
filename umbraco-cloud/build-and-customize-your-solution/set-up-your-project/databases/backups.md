...
2.  Go to **Backups** in the **Configuration** menu.
    ...
    <figure><img src="../../../.gitbook/assets/image (23).png" alt="Backups on Cloud"><figcaption><p>Backups on Cloud</p></figcaption></figure>
3.  Click **Create Backup.**

    <figure><img src="../../../.gitbook/assets/image (47).png" alt="Click Create Backup."><figcaption><p>Click Create Backup.</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/image (32).png" alt=""><figcaption><p>Creating new Backup</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/image (46).png" alt="Download or delete backup"><figcaption><p>Download or delete backup</p></figcaption></figure>
...
4.  Click **"Upload backup"** under "Database Uploads to Umbraco Cloud".
    ...
    <figure><img src="../../../.gitbook/assets/image (43).png" alt="Upload backup"><figcaption><p>Upload backup</p></figcaption></figure>
...
1.  Click on the small watch on the right side.
    ...
    <figure><img src="../../../.gitbook/assets/image (44).png" alt="Restore Database to environment"><figcaption><p>Restore Database to environment</p></figcaption></figure>
2.  Choose which environment to replace the database with the backup.

    <figure><img src="../../../.gitbook/assets/image (45).png" alt="Choose which environment to restore the backup on"><figcaption><p>Choose which environment to restore the backup on</p></figcaption></figure>
