...
From this page, you can manage whether your site is automatically upgraded to the latest minor version(s) of the Cloud products (Umbraco CMS, Forms, and Deploy). For information about opting out of automated upgrades, including patch upgrades, see the [Product Upgrades](../../../optimize-and-maintain-your-site/manage-product-upgrades/product-upgrades/README.md) article.
