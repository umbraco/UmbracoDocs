...
Your local Cloud project will need [Umbraco Deploy](https://www.nuget.org/packages/Umbraco.Deploy.OnPrem) installed, you can check your .csproj file to see if this is already installed. If not installed, install this and check your site is working as expected.
