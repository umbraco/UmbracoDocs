...
![Project History page with new CI/CD Deployment](../../.gitbook/assets/project-history-cicd.png)
...
![List of deployment artifacts on the CI/CD Flow page](../../.gitbook/assets/cicd-artifacts.png)
