...
All previous backups are neatly organized for easy access. From this list, you can opt to download the .bacpac file or delete any backup. Viewing the Backup Section requires admin permission on the cloud project.

![Database export](images/ProjectHistory.gif)
