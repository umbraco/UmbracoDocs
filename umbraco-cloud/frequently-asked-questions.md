...
You can monitor your site usage via the 'Settings' area of Umbraco Cloud. You can view Bandwidth consumption inside 'Usage' as well as CPU and Memory usage inside 'Availability & Performance'.
