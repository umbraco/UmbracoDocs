...
When upgrading an Umbraco Cloud project manually, the very first step is to [clone down your Cloud Development environment to your local machine](../../build-and-customize-your-solution/working-with-deployments/working-locally.md).
