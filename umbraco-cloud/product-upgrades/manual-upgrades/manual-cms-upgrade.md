...
* When upgrading a Umbraco Cloud project manually, the first step is to either [clone down left-most mainline environment to your local machine](../../build-and-customize-your-solution/working-with-deployments/working-locally.md) or pull down the latest changes for your left-most mainline environment.
