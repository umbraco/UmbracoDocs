...
* [Project Settings](set-up/project-settings/README.md)
  ...
  * [Umbraco CI/CD Flow](set-up/project-settings/umbraco-cicd/README.md)
    ...
    * [Configuring a CI/CD pipeline](set-up/project-settings/umbraco-cicd/samplecicdpipeline/README.md)
      * [Azure DevOps using Bash scripts](set-up/project-settings/umbraco-cicd/samplecicdpipeline/azure-devops.md)
      * [Azure DevOps using Powershell scripts](set-up/project-settings/umbraco-cicd/samplecicdpipeline/azure-devops-pwsh.md)
      * [GitHub Actions using Bash scripts](set-up/project-settings/umbraco-cicd/samplecicdpipeline/github-actions.md)
      * [GitHub Actions using Powershell scripts](set-up/project-settings/umbraco-cicd/samplecicdpipeline/github-actions-pwsh.md)
