  ...
  * [Umbraco CI/CD Flow](set-up/project-settings/umbraco-cicd/README.md)
    ...
    * [Configuring a CI/CD pipeline](set-up/project-settings/umbraco-cicd/samplecicdpipeline/README.md)
      ...
      * [Configuring a CI/CD pipeline (old)](set-up/project-settings/umbraco-cicd/samplecicdpipeline/old-setup.md)
        * [GitHub Actions using Bash scripts (Initial sample)](set-up/project-settings/umbraco-cicd/samplecicdpipeline/github-actions.md)
        * [Azure DevOps using Bash scripts (Initial sample)](set-up/project-settings/umbraco-cicd/samplecicdpipeline/azure-devops.md)
