...
* [Project Settings](set-up/project-settings/README.md)
  ...
  * [Umbraco CI/CD Flow](set-up/project-settings/umbraco-cicd/README.md)
    ...
    * [Configuring a CI/CD pipeline](set-up/project-settings/umbraco-cicd/samplecicdpipeline/README.md)
      * [Azure DevOps using Powershell scripts](set-up/project-settings/umbraco-cicd/samplecicdpipeline/azure-devops-pwsh.md)      
      * [Azure DevOps using Bash scripts](set-up/project-settings/umbraco-cicd/samplecicdpipeline/azure-devops-bash.md)
      * [GitHub Actions using Powershell scripts](set-up/project-settings/umbraco-cicd/samplecicdpipeline/
      github-actions-pwsh.md)
      * [GitHub Actions using Bash scripts](set-up/project-settings/umbraco-cicd/samplecicdpipeline/
      github-actions-bash.md)
      * [Old Azure DevOps using Bash scripts](set-up/project-settings/umbraco-cicd/samplecicdpipeline/azure-devops.md)
      * [Old GitHub Actions using Bash scripts](set-up/project-settings/umbraco-cicd/samplecicdpipeline/github-actions.md)
...
* [Manage Subscriptions](set-up/manage-subscriptions/README.md)
  * [Payments](set-up/manage-subscriptions/new-shop/README.md)
    * [Subscription migration information and FAQ](set-up/manage-subscriptions/new-shop/subscription-migration-information-and-faq.md)
