...
3. Run a ['Schema Deployment From Data Files'](../../deployments/deploy-operations/extract-schema-to-data-files.md) to extract the schema that you previously deployed.
