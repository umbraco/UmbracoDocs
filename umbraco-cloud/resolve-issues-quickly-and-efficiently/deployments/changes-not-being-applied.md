...
This issue may occur if you have added custom [Config Transforms](../../project-settings/config-transforms.md) to your project.
...
3. Run a [Schema Deployment From Data File](broken-reference) to extract the schema that you previously deployed.
