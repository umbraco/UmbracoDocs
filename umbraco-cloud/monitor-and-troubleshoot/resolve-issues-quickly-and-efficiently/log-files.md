...
Since the errors are stored in your database, it is possible to clean them up. To do this, start by [accessing the database](../../build-and-customize-your-solution/ready-to-set-up-your-project/databases/cloud-database/) for the environment where you want to run the cleanup.
