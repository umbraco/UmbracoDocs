...
For Deploy to handle Forms data as content, you'll need to ensure the `TransferFormsAsContent` the setting is set to `true` in the `appsettings.json`file:
...
![clone dialog](images/schema-mismatch\_v10.png)
