---
description: "A deployment model that relies on Git, Kudu, and Umbraco Deploy core technology to move your changes from one environment to another."
---
...
![clone dialog](<../../.gitbook/assets/Umbraco-cloud-json (1) (1) (1) (1) (1).png>)
