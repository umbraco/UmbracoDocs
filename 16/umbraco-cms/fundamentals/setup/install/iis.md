...
![Checking the IIS module exists](<../../../.gitbook/assets/iis-module (1).png>)
...
![IIS site example](<../../../.gitbook/assets/iis-site (1).png>)
...
![Launch profiles](<../../../.gitbook/assets/launchprofiles (1).png>)

And finally the site is running from your local IIS:

![Local IIS site](<../../../.gitbook/assets/voila (1).png>)
