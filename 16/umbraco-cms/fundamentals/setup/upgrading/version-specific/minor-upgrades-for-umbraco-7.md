...
If you're not upgrading to 7.2.0 or higher then you should follow these extra instructions. If you are upgrading to 7.2.0+ then you can skip this and go to [Merge UI.xml and language](minor-upgrades-for-umbraco-7.md#merge-uixml-and-language).
...
![File conflict dialog with a web.config file in conflict](<../../../../../../17/umbraco-cms/fundamentals/setup/upgrading/images/nuget-overwrite-dialog (1) (1) (1).png>) ![File conflict console message with multiple files in conflict](<../../../../../../17/umbraco-cms/fundamentals/setup/upgrading/images/nuget-upgrade-overwrite (1) (1) (1).png>)
