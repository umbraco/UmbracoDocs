...
{% hint style="info" %}
You can have a look and try out the element in the [UI API Documentation](https://apidocs.umbraco.com/v16/ui/?path=/docs/guides-localization-umblocalizeelement--docs).
{% endhint %}
...
{% hint style="info" %}
You can try out the arguments feature in the [UI API Documentation](https://apidocs.umbraco.com/v16/ui/?path=/story/guides-localization-umblocalizeelement--with-arguments).
{% endhint %}
