...
* [API Reference: GuidUdi](https://apidocs.umbraco.com/v16/csharp/api/Umbraco.Cms.Core.GuidUdi.html)

### String UDI

Used for objects that are not GUID-based, such as dictionary items.

* [API Reference: StringUdi](https://apidocs.umbraco.com/v16/csharp/api/Umbraco.Cms.Core.StringUdi.html)
