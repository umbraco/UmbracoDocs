...
51.  Now let’s fix the menu – there are two ways of doing this, you could have Umbraco dynamically create a menu from the pages it has in the Content Tree, so that when an editor creates a page it automatically appears or, more simply you can hardcode it. We’re going to hardcode this for now (it’s a good idea as you start building a site to hard code this so you can move around testing before you replace this) and we’ll leave it to you as an exercise to do this later. Edit your **_Master template_** – edit the <li> items under the <nav> tags to say:
