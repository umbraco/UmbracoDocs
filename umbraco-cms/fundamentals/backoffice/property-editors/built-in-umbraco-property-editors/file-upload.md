...
See the example below to see how a value can be added or changed programmatically. To update a value of this property editor you need the [Content Service](../../../../reference/management/services-reference/contentservice/) and the [Media Service](../../../../reference/management/services-reference/mediaservice.md).
